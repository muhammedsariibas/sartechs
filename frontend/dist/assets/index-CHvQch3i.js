...
`)+`
`+E);const b=S+h+a,P=S+E+o,L=_u(r,r.VERTEX_SHADER,b),C=_u(r,r.FRAGMENT_SHADER,P);r.attachShader(p,L),r.attachShader(p,C),t.index0AttributeName!==void 0?r.bindAttribLocation(p,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(p,0,"position"),r.linkProgram(p);function q(F){if(n.debug.checkShaderErrors){const ne=r.getProgramInfoLog(p).trim(),I=r.getShaderInfoLog(L).trim(),Z=r.getShaderInfoLog(C).trim();let k=!0,ee=!0;if(r.getProgramParameter(p,r.LINK_STATUS)===!1)if(k=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,p,L,C);else{const Y=vu(r,L,"vertex"),re=vu(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(p,r.VALIDATE_STATUS)+`
...
}`;function mS(n,e,t){let i=new md;const r=new je,s=new je,a=new wt,o=new fS({depthPacking:ag}),l=new dS,u={},c=t.maxTextureSize,f={[mi]:Xt,[Xt]:mi,[$n]:$n},d=new gi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:hS,fragmentShader:pS}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const y=new _i;y.setAttribute("position",new Cn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new gn(y,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Wf;let h=this.type;this.render=function(L,C,q){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||L.length===0)return;const K=n.getRenderTarget(),v=n.getActiveCubeFace(),A=n.getActiveMipmapLevel(),F=n.state;F.setBlending(fi),F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const ne=h!==Hn&&this.type===Hn,I=h===Hn&&this.type!==Hn;for(let Z=0,k=L.length;Z<k;Z++){const ee=L[Z],Y=ee.shadow;if(Y===void 0){console.warn("THREE.WebGLShadowMap:",ee,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;r.copy(Y.mapSize);const re=Y.getFrameExtents();if(r.multiply(re),s.copy(Y.mapSize),(r.x>c||r.y>c)&&(r.x>c&&(s.x=Math.floor(c/re.x),r.x=s.x*re.x,Y.mapSize.x=s.x),r.y>c&&(s.y=Math.floor(c/re.y),r.y=s.y*re.y,Y.mapSize.y=s.y)),Y.map===null||ne===!0||I===!0){const ue=this.type!==Hn?{minFilter:Ot,magFilter:Ot}:{};Y.map!==null&&Y.map.dispose(),Y.map=new Gi(r.x,r.y,ue),Y.map.texture.name=ee.name+".shadowMap",Y.camera.updateProjectionMatrix()}n.setRenderTarget(Y.map),n.clear();const ae=Y.getViewportCount();for(let ue=0;ue<ae;ue++){const de=Y.getViewport(ue);a.set(s.x*de.x,s.y*de.y,s.x*de.z,s.y*de.w),F.viewport(a),Y.updateMatrices(ee,ue),i=Y.getFrustum(),b(C,q,Y.camera,ee,this.type)}Y.isPointLightShadow!==!0&&this.type===Hn&&E(Y,q),Y.needsUpdate=!1}h=this.type,p.needsUpdate=!1,n.setRenderTarget(K,v,A)};function E(L,C){const q=e.update(M);d.defines.VSM_SAMPLES!==L.blurSamples&&(d.defines.VSM_SAMPLES=L.blurSamples,m.defines.VSM_SAMPLES=L.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),L.mapPass===null&&(L.mapPass=new Gi(r.x,r.y)),d.uniforms.shadow_pass.value=L.map.texture,d.uniforms.resolution.value=L.mapSize,d.uniforms.radius.value=L.radius,n.setRenderTarget(L.mapPass),n.clear(),n.renderBufferDirect(C,null,q,d,M,null),m.uniforms.shadow_pass.value=L.mapPass.texture,m.uniforms.resolution.value=L.mapSize,m.uniforms.radius.value=L.radius,n.setRenderTarget(L.map),n.clear(),n.renderBufferDirect(C,null,q,m,M,null)}function S(L,C,q,K){let v=null;const A=q.isPointLight===!0?L.customDistanceMaterial:L.customDepthMaterial;if(A!==void 0)v=A;else if(v=q.isPointLight===!0?l:o,n.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const F=v.uuid,ne=C.uuid;let I=u[F];I===void 0&&(I={},u[F]=I);let Z=I[ne];Z===void 0&&(Z=v.clone(),I[ne]=Z,C.addEventListener("dispose",P)),v=Z}if(v.visible=C.visible,v.wireframe=C.wireframe,K===Hn?v.side=C.shadowSide!==null?C.shadowSide:C.side:v.side=C.shadowSide!==null?C.shadowSide:f[C.side],v.alphaMap=C.alphaMap,v.alphaTest=C.alphaTest,v.map=C.map,v.clipShadows=C.clipShadows,v.clippingPlanes=C.clippingPlanes,v.clipIntersection=C.clipIntersection,v.displacementMap=C.displacementMap,v.displacementScale=C.displacementScale,v.displacementBias=C.displacementBias,v.wireframeLinewidth=C.wireframeLinewidth,v.linewidth=C.linewidth,q.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const F=n.properties.get(v);F.light=q}return v}function b(L,C,q,K,v){if(L.visible===!1)return;if(L.layers.test(C.layers)&&(L.isMesh||L.isLine||L.isPoints)&&(L.castShadow||L.receiveShadow&&v===Hn)&&(!L.frustumCulled||i.intersectsObject(L))){L.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,L.matrixWorld);const ne=e.update(L),I=L.material;if(Array.isArray(I)){const Z=ne.groups;for(let k=0,ee=Z.length;k<ee;k++){const Y=Z[k],re=I[Y.materialIndex];if(re&&re.visible){const ae=S(L,re,K,v);L.onBeforeShadow(n,L,C,q,ne,ae,Y),n.renderBufferDirect(q,null,ne,ae,L,Y),L.onAfterShadow(n,L,C,q,ne,ae,Y)}}}else if(I.visible){const Z=S(L,I,K,v);L.onBeforeShadow(n,L,C,q,ne,Z,null),n.renderBufferDirect(q,null,ne,Z,L,null),L.onAfterShadow(n,L,C,q,ne,Z,null)}}const F=L.children;for(let ne=0,I=F.length;ne<I;ne++)b(F[ne],C,q,K,v)}function P(L){L.target.removeEventListener("dispose",P);for(const q in u){const K=u[q],v=L.target.uuid;v in K&&(K[v].dispose(),delete K[v])}}}function gS(n,e,t){const i=t.isWebGL2;function r(){let R=!1;const he=new wt;let pe=null;const Ee=new wt(0,0,0,0);return{setMask:function(De){pe!==De&&!R&&(n.colorMask(De,De,De,De),pe=De)},setLocked:function(De){R=De},setClear:function(De,tt,lt,Et,en){en===!0&&(De*=Et,tt*=Et,lt*=Et),he.set(De,tt,lt,Et),Ee.equals(he)===!1&&(n.clearColor(De,tt,lt,Et),Ee.copy(he))},reset:function(){R=!1,pe=null,Ee.set(-1,0,0,0)}}}function s(){let R=!1,he=null,pe=null,Ee=null;return{setTest:function(De){De?ye(n.DEPTH_TEST):qe(n.DEPTH_TEST)},setMask:function(De){he!==De&&!R&&(n.depthMask(De),he=De)},setFunc:function(De){if(pe!==De){switch(De){case Om:n.depthFunc(n.NEVER);break;case Bm:n.depthFunc(n.ALWAYS);break;case zm:n.depthFunc(n.LESS);break;case to:n.depthFunc(n.LEQUAL);break;case km:n.depthFunc(n.EQUAL);break;case Hm:n.depthFunc(n.GEQUAL);break;case Gm:n.depthFunc(n.GREATER);break;case Vm:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}pe=De}},setLocked:function(De){R=De},setClear:function(De){Ee!==De&&(n.clearDepth(De),Ee=De)},reset:function(){R=!1,he=null,pe=null,Ee=null}}}function a(){let R=!1,he=null,pe=null,Ee=null,De=null,tt=null,lt=null,Et=null,en=null;return{setTest:function(ct){R||(ct?ye(n.STENCIL_TEST):qe(n.STENCIL_TEST))},setMask:function(ct){he!==ct&&!R&&(n.stencilMask(ct),he=ct)},setFunc:function(ct,It,Sn){(pe!==ct||Ee!==It||De!==Sn)&&(n.stencilFunc(ct,It,Sn),pe=ct,Ee=It,De=Sn)},setOp:function(ct,It,Sn){(tt!==ct||lt!==It||Et!==Sn)&&(n.stencilOp(ct,It,Sn),tt=ct,lt=It,Et=Sn)},setLocked:function(ct){R=ct},setClear:function(ct){en!==ct&&(n.clearStencil(ct),en=ct)},reset:function(){R=!1,he=null,pe=null,Ee=null,De=null,tt=null,lt=null,Et=null,en=null}}}const o=new r,l=new s,u=new a,c=new WeakMap,f=new WeakMap;let d={},m={},y=new WeakMap,M=[],p=null,h=!1,E=null,S=null,b=null,P=null,L=null,C=null,q=null,K=new st(0,0,0),v=0,A=!1,F=null,ne=null,I=null,Z=null,k=null;const ee=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,re=0;const ae=n.getParameter(n.VERSION);ae.indexOf("WebGL")!==-1?(re=parseFloat(/^WebGL (\d)/.exec(ae)[1]),Y=re>=1):ae.indexOf("OpenGL ES")!==-1&&(re=parseFloat(/^OpenGL ES (\d)/.exec(ae)[1]),Y=re>=2);let ue=null,de={};const Fe=n.getParameter(n.SCISSOR_BOX),J=n.getParameter(n.VIEWPORT),ce=new wt().fromArray(Fe),ve=new wt().fromArray(J);function we(R,he,pe,Ee){const De=new Uint8Array(4),tt=n.createTexture();n.bindTexture(R,tt),n.texParameteri(R,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(R,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let lt=0;lt<pe;lt++)i&&(R===n.TEXTURE_3D||R===n.TEXTURE_2D_ARRAY)?n.texImage3D(he,0,n.RGBA,1,1,Ee,0,n.RGBA,n.UNSIGNED_BYTE,De):n.texImage2D(he+lt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,De);return tt}const Ce={};Ce[n.TEXTURE_2D]=we(n.TEXTURE_2D,n.TEXTURE_2D,1),Ce[n.TEXTURE_CUBE_MAP]=we(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(Ce[n.TEXTURE_2D_ARRAY]=we(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Ce[n.TEXTURE_3D]=we(n.TEXTURE_3D,n.TEXTURE_3D,1,1)),o.setClear(0,0,0,1),l.setClear(1),u.setClear(0),ye(n.DEPTH_TEST),l.setFunc(to),te(!1),x(rc),ye(n.CULL_FACE),z(fi);function ye(R){d[R]!==!0&&(n.enable(R),d[R]=!0)}function qe(R){d[R]!==!1&&(n.disable(R),d[R]=!1)}function Be(R,he){return m[R]!==he?(n.bindFramebuffer(R,he),m[R]=he,i&&(R===n.DRAW_FRAMEBUFFER&&(m[n.FRAMEBUFFER]=he),R===n.FRAMEBUFFER&&(m[n.DRAW_FRAMEBUFFER]=he)),!0):!1}function _(R,he){let pe=M,Ee=!1;if(R)if(pe=y.get(he),pe===void 0&&(pe=[],y.set(he,pe)),R.isWebGLMultipleRenderTargets){const De=R.texture;if(pe.length!==De.length||pe[0]!==n.COLOR_ATTACHMENT0){for(let tt=0,lt=De.length;tt<lt;tt++)pe[tt]=n.COLOR_ATTACHMENT0+tt;pe.length=De.length,Ee=!0}}else pe[0]!==n.COLOR_ATTACHMENT0&&(pe[0]=n.COLOR_ATTACHMENT0,Ee=!0);else pe[0]!==n.BACK&&(pe[0]=n.BACK,Ee=!0);Ee&&(t.isWebGL2?n.drawBuffers(pe):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(pe))}function U(R){return p!==R?(n.useProgram(R),p=R,!0):!1}const N={[Di]:n.FUNC_ADD,[Mm]:n.FUNC_SUBTRACT,[bm]:n.FUNC_REVERSE_SUBTRACT};if(i)N[lc]=n.MIN,N[cc]=n.MAX;else{const R=e.get("EXT_blend_minmax");R!==null&&(N[lc]=R.MIN_EXT,N[cc]=R.MAX_EXT)}const X={[Em]:n.ZERO,[Tm]:n.ONE,[Am]:n.SRC_COLOR,[Na]:n.SRC_ALPHA,[Dm]:n.SRC_ALPHA_SATURATE,[Lm]:n.DST_COLOR,[Rm]:n.DST_ALPHA,[wm]:n.ONE_MINUS_SRC_COLOR,[Fa]:n.ONE_MINUS_SRC_ALPHA,[Pm]:n.ONE_MINUS_DST_COLOR,[Cm]:n.ONE_MINUS_DST_ALPHA,[Um]:n.CONSTANT_COLOR,[Im]:n.ONE_MINUS_CONSTANT_COLOR,[Nm]:n.CONSTANT_ALPHA,[Fm]:n.ONE_MINUS_CONSTANT_ALPHA};function z(R,he,pe,Ee,De,tt,lt,Et,en,ct){if(R===fi){h===!0&&(qe(n.BLEND),h=!1);return}if(h===!1&&(ye(n.BLEND),h=!0),R!==ym){if(R!==E||ct!==A){if((S!==Di||L!==Di)&&(n.blendEquation(n.FUNC_ADD),S=Di,L=Di),ct)switch(R){case pr:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case sc:n.blendFunc(n.ONE,n.ONE);break;case oc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ac:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}else switch(R){case pr:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case sc:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case oc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case ac:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",R);break}b=null,P=null,C=null,q=null,K.set(0,0,0),v=0,E=R,A=ct}return}De=De||he,tt=tt||pe,lt=lt||Ee,(he!==S||De!==L)&&(n.blendEquationSeparate(N[he],N[De]),S=he,L=De),(pe!==b||Ee!==P||tt!==C||lt!==q)&&(n.blendFuncSeparate(X[pe],X[Ee],X[tt],X[lt]),b=pe,P=Ee,C=tt,q=lt),(Et.equals(K)===!1||en!==v)&&(n.blendColor(Et.r,Et.g,Et.b,en),K.copy(Et),v=en),E=R,A=!1}function Q(R,he){R.side===$n?qe(n.CULL_FACE):ye(n.CULL_FACE);let pe=R.side===Xt;he&&(pe=!pe),te(pe),R.blending===pr&&R.transparent===!1?z(fi):z(R.blending,R.blendEquation,R.blendSrc,R.blendDst,R.blendEquationAlpha,R.blendSrcAlpha,R.blendDstAlpha,R.blendColor,R.blendAlpha,R.premultipliedAlpha),l.setFunc(R.depthFunc),l.setTest(R.depthTest),l.setMask(R.depthWrite),o.setMask(R.colorWrite);const Ee=R.stencilWrite;u.setTest(Ee),Ee&&(u.setMask(R.stencilWriteMask),u.setFunc(R.stencilFunc,R.stencilRef,R.stencilFuncMask),u.setOp(R.stencilFail,R.stencilZFail,R.stencilZPass)),w(R.polygonOffset,R.polygonOffsetFactor,R.polygonOffsetUnits),R.alphaToCoverage===!0?ye(n.SAMPLE_ALPHA_TO_COVERAGE):qe(n.SAMPLE_ALPHA_TO_COVERAGE)}function te(R){F!==R&&(R?n.frontFace(n.CW):n.frontFace(n.CCW),F=R)}function x(R){R!==vm?(ye(n.CULL_FACE),R!==ne&&(R===rc?n.cullFace(n.BACK):R===xm?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):qe(n.CULL_FACE),ne=R}function g(R){R!==I&&(Y&&n.lineWidth(R),I=R)}function w(R,he,pe){R?(ye(n.POLYGON_OFFSET_FILL),(Z!==he||k!==pe)&&(n.polygonOffset(he,pe),Z=he,k=pe)):qe(n.POLYGON_OFFSET_FILL)}function W(R){R?ye(n.SCISSOR_TEST):qe(n.SCISSOR_TEST)}function O(R){R===void 0&&(R=n.TEXTURE0+ee-1),ue!==R&&(n.activeTexture(R),ue=R)}function G(R,he,pe){pe===void 0&&(ue===null?pe=n.TEXTURE0+ee-1:pe=ue);let Ee=de[pe];Ee===void 0&&(Ee={type:void 0,texture:void 0},de[pe]=Ee),(Ee.type!==R||Ee.texture!==he)&&(ue!==pe&&(n.activeTexture(pe),ue=pe),n.bindTexture(R,he||Ce[R]),Ee.type=R,Ee.texture=he)}function oe(){const R=de[ue];R!==void 0&&R.type!==void 0&&(n.bindTexture(R.type,null),R.type=void 0,R.texture=void 0)}function se(){try{n.compressedTexImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function fe(){try{n.compressedTexImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ge(){try{n.texSubImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Me(){try{n.texSubImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function ie(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ve(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ie(){try{n.texStorage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Ue(){try{n.texStorage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Re(){try{n.texImage2D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function _e(){try{n.texImage3D.apply(n,arguments)}catch(R){console.error("THREE.WebGLState:",R)}}function Pe(R){ce.equals(R)===!1&&(n.scissor(R.x,R.y,R.z,R.w),ce.copy(R))}function Ke(R){ve.equals(R)===!1&&(n.viewport(R.x,R.y,R.z,R.w),ve.copy(R))}function nt(R,he){let pe=f.get(he);pe===void 0&&(pe=new WeakMap,f.set(he,pe));let Ee=pe.get(R);Ee===void 0&&(Ee=n.getUniformBlockIndex(he,R.name),pe.set(R,Ee))}function Ye(R,he){const Ee=f.get(he).get(R);c.get(he)!==Ee&&(n.uniformBlockBinding(he,Ee,R.__bindingPointIndex),c.set(he,Ee))}function ot(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),i===!0&&(n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),d={},ue=null,de={},m={},y=new WeakMap,M=[],p=null,h=!1,E=null,S=null,b=null,P=null,L=null,C=null,q=null,K=new st(0,0,0),v=0,A=!1,F=null,ne=null,I=null,Z=null,k=null,ce.set(0,0,n.canvas.width,n.canvas.height),ve.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),u.reset()}return{buffers:{color:o,depth:l,stencil:u},enable:ye,disable:qe,bindFramebuffer:Be,drawBuffers:_,useProgram:U,setBlending:z,setMaterial:Q,setFlipSided:te,setCullFace:x,setLineWidth:g,setPolygonOffset:w,setScissorTest:W,activeTexture:O,bindTexture:G,unbindTexture:oe,compressedTexImage2D:se,compressedTexImage3D:fe,texImage2D:Re,texImage3D:_e,updateUBOMapping:nt,uniformBlockBinding:Ye,texStorage2D:Ie,texStorage3D:Ue,texSubImage2D:ge,texSubImage3D:Me,compressedTexSubImage2D:ie,compressedTexSubImage3D:Ve,scissor:Pe,viewport:Ke,reset:ot}}function _S(n,e,t,i,r,s,a){const o=r.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,u=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new WeakMap;let f;const d=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(x,g){return m?new OffscreenCanvas(x,g):oo("canvas")}function M(x,g,w,W){let O=1;if((x.width>W||x.height>W)&&(O=W/Math.max(x.width,x.height)),O<1||g===!0)if(typeof HTMLImageElement<"u"&&x instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&x instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&x instanceof ImageBitmap){const G=g?Va:Math.floor,oe=G(O*x.width),se=G(O*x.height);f===void 0&&(f=y(oe,se));const fe=w?y(oe,se):f;return fe.width=oe,fe.height=se,fe.getContext("2d").drawImage(x,0,0,oe,se),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+x.width+"x"+x.height+") to ("+oe+"x"+se+")."),fe}else return"data"in x&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+x.width+"x"+x.height+")."),x;return x}function p(x){return zc(x.width)&&zc(x.height)}function h(x){return o?!1:x.wrapS!==pn||x.wrapT!==pn||x.minFilter!==Ot&&x.minFilter!==Vt}function E(x,g){return x.generateMipmaps&&g&&x.minFilter!==Ot&&x.minFilter!==Vt}function S(x){n.generateMipmap(x)}function b(x,g,w,W,O=!1){if(o===!1)return g;if(x!==null){if(n[x]!==void 0)return n[x];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+x+"'")}let G=g;if(g===n.RED&&(w===n.FLOAT&&(G=n.R32F),w===n.HALF_FLOAT&&(G=n.R16F),w===n.UNSIGNED_BYTE&&(G=n.R8)),g===n.RED_INTEGER&&(w===n.UNSIGNED_BYTE&&(G=n.R8UI),w===n.UNSIGNED_SHORT&&(G=n.R16UI),w===n.UNSIGNED_INT&&(G=n.R32UI),w===n.BYTE&&(G=n.R8I),w===n.SHORT&&(G=n.R16I),w===n.INT&&(G=n.R32I)),g===n.RG&&(w===n.FLOAT&&(G=n.RG32F),w===n.HALF_FLOAT&&(G=n.RG16F),w===n.UNSIGNED_BYTE&&(G=n.RG8)),g===n.RGBA){const oe=O?no:it.getTransfer(W);w===n.FLOAT&&(G=n.RGBA32F),w===n.HALF_FLOAT&&(G=n.RGBA16F),w===n.UNSIGNED_BYTE&&(G=oe===ft?n.SRGB8_ALPHA8:n.RGBA8),w===n.UNSIGNED_SHORT_4_4_4_4&&(G=n.RGBA4),w===n.UNSIGNED_SHORT_5_5_5_1&&(G=n.RGB5_A1)}return(G===n.R16F||G===n.R32F||G===n.RG16F||G===n.RG32F||G===n.RGBA16F||G===n.RGBA32F)&&e.get("EXT_color_buffer_float"),G}function P(x,g,w){return E(x,w)===!0||x.isFramebufferTexture&&x.minFilter!==Ot&&x.minFilter!==Vt?Math.log2(Math.max(g.width,g.height))+1:x.mipmaps!==void 0&&x.mipmaps.length>0?x.mipmaps.length:x.isCompressedTexture&&Array.isArray(x.image)?g.mipmaps.length:1}function L(x){return x===Ot||x===uc||x===Dr?n.NEAREST:n.LINEAR}function C(x){const g=x.target;g.removeEventListener("dispose",C),K(g),g.isVideoTexture&&c.delete(g)}function q(x){const g=x.target;g.removeEventListener("dispose",q),A(g)}function K(x){const g=i.get(x);if(g.__webglInit===void 0)return;const w=x.source,W=d.get(w);if(W){const O=W[g.__cacheKey];O.usedTimes--,O.usedTimes===0&&v(x),Object.keys(W).length===0&&d.delete(w)}i.remove(x)}function v(x){const g=i.get(x);n.deleteTexture(g.__webglTexture);const w=x.source,W=d.get(w);delete W[g.__cacheKey],a.memory.textures--}function A(x){const g=x.texture,w=i.get(x),W=i.get(g);if(W.__webglTexture!==void 0&&(n.deleteTexture(W.__webglTexture),a.memory.textures--),x.depthTexture&&x.depthTexture.dispose(),x.isWebGLCubeRenderTarget)for(let O=0;O<6;O++){if(Array.isArray(w.__webglFramebuffer[O]))for(let G=0;G<w.__webglFramebuffer[O].length;G++)n.deleteFramebuffer(w.__webglFramebuffer[O][G]);else n.deleteFramebuffer(w.__webglFramebuffer[O]);w.__webglDepthbuffer&&n.deleteRenderbuffer(w.__webglDepthbuffer[O])}else{if(Array.isArray(w.__webglFramebuffer))for(let O=0;O<w.__webglFramebuffer.length;O++)n.deleteFramebuffer(w.__webglFramebuffer[O]);else n.deleteFramebuffer(w.__webglFramebuffer);if(w.__webglDepthbuffer&&n.deleteRenderbuffer(w.__webglDepthbuffer),w.__webglMultisampledFramebuffer&&n.deleteFramebuffer(w.__webglMultisampledFramebuffer),w.__webglColorRenderbuffer)for(let O=0;O<w.__webglColorRenderbuffer.length;O++)w.__webglColorRenderbuffer[O]&&n.deleteRenderbuffer(w.__webglColorRenderbuffer[O]);w.__webglDepthRenderbuffer&&n.deleteRenderbuffer(w.__webglDepthRenderbuffer)}if(x.isWebGLMultipleRenderTargets)for(let O=0,G=g.length;O<G;O++){const oe=i.get(g[O]);oe.__webglTexture&&(n.deleteTexture(oe.__webglTexture),a.memory.textures--),i.remove(g[O])}i.remove(g),i.remove(x)}let F=0;function ne(){F=0}function I(){const x=F;return x>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+x+" texture units while this GPU supports only "+r.maxTextures),F+=1,x}function Z(x){const g=[];return g.push(x.wrapS),g.push(x.wrapT),g.push(x.wrapR||0),g.push(x.magFilter),g.push(x.minFilter),g.push(x.anisotropy),g.push(x.internalFormat),g.push(x.format),g.push(x.type),g.push(x.generateMipmaps),g.push(x.premultiplyAlpha),g.push(x.flipY),g.push(x.unpackAlignment),g.push(x.colorSpace),g.join()}function k(x,g){const w=i.get(x);if(x.isVideoTexture&&Q(x),x.isRenderTargetTexture===!1&&x.version>0&&w.__version!==x.version){const W=x.image;if(W===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ce(w,x,g);return}}t.bindTexture(n.TEXTURE_2D,w.__webglTexture,n.TEXTURE0+g)}function ee(x,g){const w=i.get(x);if(x.version>0&&w.__version!==x.version){ce(w,x,g);return}t.bindTexture(n.TEXTURE_2D_ARRAY,w.__webglTexture,n.TEXTURE0+g)}function Y(x,g){const w=i.get(x);if(x.version>0&&w.__version!==x.version){ce(w,x,g);return}t.bindTexture(n.TEXTURE_3D,w.__webglTexture,n.TEXTURE0+g)}function re(x,g){const w=i.get(x);if(x.version>0&&w.__version!==x.version){ve(w,x,g);return}t.bindTexture(n.TEXTURE_CUBE_MAP,w.__webglTexture,n.TEXTURE0+g)}const ae={[za]:n.REPEAT,[pn]:n.CLAMP_TO_EDGE,[ka]:n.MIRRORED_REPEAT},ue={[Ot]:n.NEAREST,[uc]:n.NEAREST_MIPMAP_NEAREST,[Dr]:n.NEAREST_MIPMAP_LINEAR,[Vt]:n.LINEAR,[Xo]:n.LINEAR_MIPMAP_NEAREST,[Ii]:n.LINEAR_MIPMAP_LINEAR},de={[cg]:n.NEVER,[mg]:n.ALWAYS,[ug]:n.LESS,[nd]:n.LEQUAL,[fg]:n.EQUAL,[pg]:n.GEQUAL,[dg]:n.GREATER,[hg]:n.NOTEQUAL};function Fe(x,g,w){if(g.type===qn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Vt||g.magFilter===Xo||g.magFilter===Dr||g.magFilter===Ii||g.minFilter===Vt||g.minFilter===Xo||g.minFilter===Dr||g.minFilter===Ii)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),w?(n.texParameteri(x,n.TEXTURE_WRAP_S,ae[g.wrapS]),n.texParameteri(x,n.TEXTURE_WRAP_T,ae[g.wrapT]),(x===n.TEXTURE_3D||x===n.TEXTURE_2D_ARRAY)&&n.texParameteri(x,n.TEXTURE_WRAP_R,ae[g.wrapR]),n.texParameteri(x,n.TEXTURE_MAG_FILTER,ue[g.magFilter]),n.texParameteri(x,n.TEXTURE_MIN_FILTER,ue[g.minFilter])):(n.texParameteri(x,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(x,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE),(x===n.TEXTURE_3D||x===n.TEXTURE_2D_ARRAY)&&n.texParameteri(x,n.TEXTURE_WRAP_R,n.CLAMP_TO_EDGE),(g.wrapS!==pn||g.wrapT!==pn)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(x,n.TEXTURE_MAG_FILTER,L(g.magFilter)),n.texParameteri(x,n.TEXTURE_MIN_FILTER,L(g.minFilter)),g.minFilter!==Ot&&g.minFilter!==Vt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),g.compareFunction&&(n.texParameteri(x,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(x,n.TEXTURE_COMPARE_FUNC,de[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const W=e.get("EXT_texture_filter_anisotropic");if(g.magFilter===Ot||g.minFilter!==Dr&&g.minFilter!==Ii||g.type===qn&&e.has("OES_texture_float_linear")===!1||o===!1&&g.type===is&&e.has("OES_texture_half_float_linear")===!1)return;(g.anisotropy>1||i.get(g).__currentAnisotropy)&&(n.texParameterf(x,W.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),i.get(g).__currentAnisotropy=g.anisotropy)}}function J(x,g){let w=!1;x.__webglInit===void 0&&(x.__webglInit=!0,g.addEventListener("dispose",C));const W=g.source;let O=d.get(W);O===void 0&&(O={},d.set(W,O));const G=Z(g);if(G!==x.__cacheKey){O[G]===void 0&&(O[G]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,w=!0),O[G].usedTimes++;const oe=O[x.__cacheKey];oe!==void 0&&(O[x.__cacheKey].usedTimes--,oe.usedTimes===0&&v(g)),x.__cacheKey=G,x.__webglTexture=O[G].texture}return w}function ce(x,g,w){let W=n.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(W=n.TEXTURE_2D_ARRAY),g.isData3DTexture&&(W=n.TEXTURE_3D);const O=J(x,g),G=g.source;t.bindTexture(W,x.__webglTexture,n.TEXTURE0+w);const oe=i.get(G);if(G.version!==oe.__version||O===!0){t.activeTexture(n.TEXTURE0+w);const se=it.getPrimaries(it.workingColorSpace),fe=g.colorSpace===an?null:it.getPrimaries(g.colorSpace),ge=g.colorSpace===an||se===fe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge);const Me=h(g)&&p(g.image)===!1;let ie=M(g.image,Me,!1,r.maxTextureSize);ie=te(g,ie);const Ve=p(ie)||o,Ie=s.convert(g.format,g.colorSpace);let Ue=s.convert(g.type),Re=b(g.internalFormat,Ie,Ue,g.colorSpace,g.isVideoTexture);Fe(W,g,Ve);let _e;const Pe=g.mipmaps,Ke=o&&g.isVideoTexture!==!0&&Re!==Qf,nt=oe.__version===void 0||O===!0,Ye=G.dataReady,ot=P(g,ie,Ve);if(g.isDepthTexture)Re=n.DEPTH_COMPONENT,o?g.type===qn?Re=n.DEPTH_COMPONENT32F:g.type===ui?Re=n.DEPTH_COMPONENT24:g.type===Bi?Re=n.DEPTH24_STENCIL8:Re=n.DEPTH_COMPONENT16:g.type===qn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),g.format===zi&&Re===n.DEPTH_COMPONENT&&g.type!==al&&g.type!==ui&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),g.type=ui,Ue=s.convert(g.type)),g.format===yr&&Re===n.DEPTH_COMPONENT&&(Re=n.DEPTH_STENCIL,g.type!==Bi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),g.type=Bi,Ue=s.convert(g.type))),nt&&(Ke?t.texStorage2D(n.TEXTURE_2D,1,Re,ie.width,ie.height):t.texImage2D(n.TEXTURE_2D,0,Re,ie.width,ie.height,0,Ie,Ue,null));else if(g.isDataTexture)if(Pe.length>0&&Ve){Ke&&nt&&t.texStorage2D(n.TEXTURE_2D,ot,Re,Pe[0].width,Pe[0].height);for(let R=0,he=Pe.length;R<he;R++)_e=Pe[R],Ke?Ye&&t.texSubImage2D(n.TEXTURE_2D,R,0,0,_e.width,_e.height,Ie,Ue,_e.data):t.texImage2D(n.TEXTURE_2D,R,Re,_e.width,_e.height,0,Ie,Ue,_e.data);g.generateMipmaps=!1}else Ke?(nt&&t.texStorage2D(n.TEXTURE_2D,ot,Re,ie.width,ie.height),Ye&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,ie.width,ie.height,Ie,Ue,ie.data)):t.texImage2D(n.TEXTURE_2D,0,Re,ie.width,ie.height,0,Ie,Ue,ie.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ke&&nt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ot,Re,Pe[0].width,Pe[0].height,ie.depth);for(let R=0,he=Pe.length;R<he;R++)_e=Pe[R],g.format!==mn?Ie!==null?Ke?Ye&&t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,R,0,0,0,_e.width,_e.height,ie.depth,Ie,_e.data,0,0):t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,R,Re,_e.width,_e.height,ie.depth,0,_e.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ke?Ye&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,R,0,0,0,_e.width,_e.height,ie.depth,Ie,Ue,_e.data):t.texImage3D(n.TEXTURE_2D_ARRAY,R,Re,_e.width,_e.height,ie.depth,0,Ie,Ue,_e.data)}else{Ke&&nt&&t.texStorage2D(n.TEXTURE_2D,ot,Re,Pe[0].width,Pe[0].height);for(let R=0,he=Pe.length;R<he;R++)_e=Pe[R],g.format!==mn?Ie!==null?Ke?Ye&&t.compressedTexSubImage2D(n.TEXTURE_2D,R,0,0,_e.width,_e.height,Ie,_e.data):t.compressedTexImage2D(n.TEXTURE_2D,R,Re,_e.width,_e.height,0,_e.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ke?Ye&&t.texSubImage2D(n.TEXTURE_2D,R,0,0,_e.width,_e.height,Ie,Ue,_e.data):t.texImage2D(n.TEXTURE_2D,R,Re,_e.width,_e.height,0,Ie,Ue,_e.data)}else if(g.isDataArrayTexture)Ke?(nt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ot,Re,ie.width,ie.height,ie.depth),Ye&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,Ie,Ue,ie.data)):t.texImage3D(n.TEXTURE_2D_ARRAY,0,Re,ie.width,ie.height,ie.depth,0,Ie,Ue,ie.data);else if(g.isData3DTexture)Ke?(nt&&t.texStorage3D(n.TEXTURE_3D,ot,Re,ie.width,ie.height,ie.depth),Ye&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,Ie,Ue,ie.data)):t.texImage3D(n.TEXTURE_3D,0,Re,ie.width,ie.height,ie.depth,0,Ie,Ue,ie.data);else if(g.isFramebufferTexture){if(nt)if(Ke)t.texStorage2D(n.TEXTURE_2D,ot,Re,ie.width,ie.height);else{let R=ie.width,he=ie.height;for(let pe=0;pe<ot;pe++)t.texImage2D(n.TEXTURE_2D,pe,Re,R,he,0,Ie,Ue,null),R>>=1,he>>=1}}else if(Pe.length>0&&Ve){Ke&&nt&&t.texStorage2D(n.TEXTURE_2D,ot,Re,Pe[0].width,Pe[0].height);for(let R=0,he=Pe.length;R<he;R++)_e=Pe[R],Ke?Ye&&t.texSubImage2D(n.TEXTURE_2D,R,0,0,Ie,Ue,_e):t.texImage2D(n.TEXTURE_2D,R,Re,Ie,Ue,_e);g.generateMipmaps=!1}else Ke?(nt&&t.texStorage2D(n.TEXTURE_2D,ot,Re,ie.width,ie.height),Ye&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,Ie,Ue,ie)):t.texImage2D(n.TEXTURE_2D,0,Re,Ie,Ue,ie);E(g,Ve)&&S(W),oe.__version=G.version,g.onUpdate&&g.onUpdate(g)}x.__version=g.version}function ve(x,g,w){if(g.image.length!==6)return;const W=J(x,g),O=g.source;t.bindTexture(n.TEXTURE_CUBE_MAP,x.__webglTexture,n.TEXTURE0+w);const G=i.get(O);if(O.version!==G.__version||W===!0){t.activeTexture(n.TEXTURE0+w);const oe=it.getPrimaries(it.workingColorSpace),se=g.colorSpace===an?null:it.getPrimaries(g.colorSpace),fe=g.colorSpace===an||oe===se?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,g.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,g.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe);const ge=g.isCompressedTexture||g.image[0].isCompressedTexture,Me=g.image[0]&&g.image[0].isDataTexture,ie=[];for(let R=0;R<6;R++)!ge&&!Me?ie[R]=M(g.image[R],!1,!0,r.maxCubemapSize):ie[R]=Me?g.image[R].image:g.image[R],ie[R]=te(g,ie[R]);const Ve=ie[0],Ie=p(Ve)||o,Ue=s.convert(g.format,g.colorSpace),Re=s.convert(g.type),_e=b(g.internalFormat,Ue,Re,g.colorSpace),Pe=o&&g.isVideoTexture!==!0,Ke=G.__version===void 0||W===!0,nt=O.dataReady;let Ye=P(g,Ve,Ie);Fe(n.TEXTURE_CUBE_MAP,g,Ie);let ot;if(ge){Pe&&Ke&&t.texStorage2D(n.TEXTURE_CUBE_MAP,Ye,_e,Ve.width,Ve.height);for(let R=0;R<6;R++){ot=ie[R].mipmaps;for(let he=0;he<ot.length;he++){const pe=ot[he];g.format!==mn?Ue!==null?Pe?nt&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,he,0,0,pe.width,pe.height,Ue,pe.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,he,_e,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Pe?nt&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,he,0,0,pe.width,pe.height,Ue,Re,pe.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,he,_e,pe.width,pe.height,0,Ue,Re,pe.data)}}}else{ot=g.mipmaps,Pe&&Ke&&(ot.length>0&&Ye++,t.texStorage2D(n.TEXTURE_CUBE_MAP,Ye,_e,ie[0].width,ie[0].height));for(let R=0;R<6;R++)if(Me){Pe?nt&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,0,0,0,ie[R].width,ie[R].height,Ue,Re,ie[R].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,0,_e,ie[R].width,ie[R].height,0,Ue,Re,ie[R].data);for(let he=0;he<ot.length;he++){const Ee=ot[he].image[R].image;Pe?nt&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,he+1,0,0,Ee.width,Ee.height,Ue,Re,Ee.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,he+1,_e,Ee.width,Ee.height,0,Ue,Re,Ee.data)}}else{Pe?nt&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,0,0,0,Ue,Re,ie[R]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,0,_e,Ue,Re,ie[R]);for(let he=0;he<ot.length;he++){const pe=ot[he];Pe?nt&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,he+1,0,0,Ue,Re,pe.image[R]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+R,he+1,_e,Ue,Re,pe.image[R])}}}E(g,Ie)&&S(n.TEXTURE_CUBE_MAP),G.__version=O.version,g.onUpdate&&g.onUpdate(g)}x.__version=g.version}function we(x,g,w,W,O,G){const oe=s.convert(w.format,w.colorSpace),se=s.convert(w.type),fe=b(w.internalFormat,oe,se,w.colorSpace);if(!i.get(g).__hasExternalTextures){const Me=Math.max(1,g.width>>G),ie=Math.max(1,g.height>>G);O===n.TEXTURE_3D||O===n.TEXTURE_2D_ARRAY?t.texImage3D(O,G,fe,Me,ie,g.depth,0,oe,se,null):t.texImage2D(O,G,fe,Me,ie,0,oe,se,null)}t.bindFramebuffer(n.FRAMEBUFFER,x),z(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,W,O,i.get(w).__webglTexture,0,X(g)):(O===n.TEXTURE_2D||O>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&O<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,W,O,i.get(w).__webglTexture,G),t.bindFramebuffer(n.FRAMEBUFFER,null)}function Ce(x,g,w){if(n.bindRenderbuffer(n.RENDERBUFFER,x),g.depthBuffer&&!g.stencilBuffer){let W=o===!0?n.DEPTH_COMPONENT24:n.DEPTH_COMPONENT16;if(w||z(g)){const O=g.depthTexture;O&&O.isDepthTexture&&(O.type===qn?W=n.DEPTH_COMPONENT32F:O.type===ui&&(W=n.DEPTH_COMPONENT24));const G=X(g);z(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,G,W,g.width,g.height):n.renderbufferStorageMultisample(n.RENDERBUFFER,G,W,g.width,g.height)}else n.renderbufferStorage(n.RENDERBUFFER,W,g.width,g.height);n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.RENDERBUFFER,x)}else if(g.depthBuffer&&g.stencilBuffer){const W=X(g);w&&z(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,W,n.DEPTH24_STENCIL8,g.width,g.height):z(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,W,n.DEPTH24_STENCIL8,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,n.DEPTH_STENCIL,g.width,g.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.RENDERBUFFER,x)}else{const W=g.isWebGLMultipleRenderTargets===!0?g.texture:[g.texture];for(let O=0;O<W.length;O++){const G=W[O],oe=s.convert(G.format,G.colorSpace),se=s.convert(G.type),fe=b(G.internalFormat,oe,se,G.colorSpace),ge=X(g);w&&z(g)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,ge,fe,g.width,g.height):z(g)?l.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,ge,fe,g.width,g.height):n.renderbufferStorage(n.RENDERBUFFER,fe,g.width,g.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ye(x,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,x),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),k(g.depthTexture,0);const W=i.get(g.depthTexture).__webglTexture,O=X(g);if(g.depthTexture.format===zi)z(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,W,0,O):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,W,0);else if(g.depthTexture.format===yr)z(g)?l.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,W,0,O):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,W,0);else throw new Error("Unknown depthTexture format")}function qe(x){const g=i.get(x),w=x.isWebGLCubeRenderTarget===!0;if(x.depthTexture&&!g.__autoAllocateDepthBuffer){if(w)throw new Error("target.depthTexture not supported in Cube render targets");ye(g.__webglFramebuffer,x)}else if(w){g.__webglDepthbuffer=[];for(let W=0;W<6;W++)t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer[W]),g.__webglDepthbuffer[W]=n.createRenderbuffer(),Ce(g.__webglDepthbuffer[W],x,!1)}else t.bindFramebuffer(n.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=n.createRenderbuffer(),Ce(g.__webglDepthbuffer,x,!1);t.bindFramebuffer(n.FRAMEBUFFER,null)}function Be(x,g,w){const W=i.get(x);g!==void 0&&we(W.__webglFramebuffer,x,x.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),w!==void 0&&qe(x)}function _(x){const g=x.texture,w=i.get(x),W=i.get(g);x.addEventListener("dispose",q),x.isWebGLMultipleRenderTargets!==!0&&(W.__webglTexture===void 0&&(W.__webglTexture=n.createTexture()),W.__version=g.version,a.memory.textures++);const O=x.isWebGLCubeRenderTarget===!0,G=x.isWebGLMultipleRenderTargets===!0,oe=p(x)||o;if(O){w.__webglFramebuffer=[];for(let se=0;se<6;se++)if(o&&g.mipmaps&&g.mipmaps.length>0){w.__webglFramebuffer[se]=[];for(let fe=0;fe<g.mipmaps.length;fe++)w.__webglFramebuffer[se][fe]=n.createFramebuffer()}else w.__webglFramebuffer[se]=n.createFramebuffer()}else{if(o&&g.mipmaps&&g.mipmaps.length>0){w.__webglFramebuffer=[];for(let se=0;se<g.mipmaps.length;se++)w.__webglFramebuffer[se]=n.createFramebuffer()}else w.__webglFramebuffer=n.createFramebuffer();if(G)if(r.drawBuffers){const se=x.texture;for(let fe=0,ge=se.length;fe<ge;fe++){const Me=i.get(se[fe]);Me.__webglTexture===void 0&&(Me.__webglTexture=n.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&x.samples>0&&z(x)===!1){const se=G?g:[g];w.__webglMultisampledFramebuffer=n.createFramebuffer(),w.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,w.__webglMultisampledFramebuffer);for(let fe=0;fe<se.length;fe++){const ge=se[fe];w.__webglColorRenderbuffer[fe]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,w.__webglColorRenderbuffer[fe]);const Me=s.convert(ge.format,ge.colorSpace),ie=s.convert(ge.type),Ve=b(ge.internalFormat,Me,ie,ge.colorSpace,x.isXRRenderTarget===!0),Ie=X(x);n.renderbufferStorageMultisample(n.RENDERBUFFER,Ie,Ve,x.width,x.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.RENDERBUFFER,w.__webglColorRenderbuffer[fe])}n.bindRenderbuffer(n.RENDERBUFFER,null),x.depthBuffer&&(w.__webglDepthRenderbuffer=n.createRenderbuffer(),Ce(w.__webglDepthRenderbuffer,x,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(O){t.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture),Fe(n.TEXTURE_CUBE_MAP,g,oe);for(let se=0;se<6;se++)if(o&&g.mipmaps&&g.mipmaps.length>0)for(let fe=0;fe<g.mipmaps.length;fe++)we(w.__webglFramebuffer[se][fe],x,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+se,fe);else we(w.__webglFramebuffer[se],x,g,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+se,0);E(g,oe)&&S(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(G){const se=x.texture;for(let fe=0,ge=se.length;fe<ge;fe++){const Me=se[fe],ie=i.get(Me);t.bindTexture(n.TEXTURE_2D,ie.__webglTexture),Fe(n.TEXTURE_2D,Me,oe),we(w.__webglFramebuffer,x,Me,n.COLOR_ATTACHMENT0+fe,n.TEXTURE_2D,0),E(Me,oe)&&S(n.TEXTURE_2D)}t.unbindTexture()}else{let se=n.TEXTURE_2D;if((x.isWebGL3DRenderTarget||x.isWebGLArrayRenderTarget)&&(o?se=x.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(se,W.__webglTexture),Fe(se,g,oe),o&&g.mipmaps&&g.mipmaps.length>0)for(let fe=0;fe<g.mipmaps.length;fe++)we(w.__webglFramebuffer[fe],x,g,n.COLOR_ATTACHMENT0,se,fe);else we(w.__webglFramebuffer,x,g,n.COLOR_ATTACHMENT0,se,0);E(g,oe)&&S(se),t.unbindTexture()}x.depthBuffer&&qe(x)}function U(x){const g=p(x)||o,w=x.isWebGLMultipleRenderTargets===!0?x.texture:[x.texture];for(let W=0,O=w.length;W<O;W++){const G=w[W];if(E(G,g)){const oe=x.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,se=i.get(G).__webglTexture;t.bindTexture(oe,se),S(oe),t.unbindTexture()}}}function N(x){if(o&&x.samples>0&&z(x)===!1){const g=x.isWebGLMultipleRenderTargets?x.texture:[x.texture],w=x.width,W=x.height;let O=n.COLOR_BUFFER_BIT;const G=[],oe=x.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,se=i.get(x),fe=x.isWebGLMultipleRenderTargets===!0;if(fe)for(let ge=0;ge<g.length;ge++)t.bindFramebuffer(n.FRAMEBUFFER,se.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,se.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,se.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,se.__webglFramebuffer);for(let ge=0;ge<g.length;ge++){G.push(n.COLOR_ATTACHMENT0+ge),x.depthBuffer&&G.push(oe);const Me=se.__ignoreDepthValues!==void 0?se.__ignoreDepthValues:!1;if(Me===!1&&(x.depthBuffer&&(O|=n.DEPTH_BUFFER_BIT),x.stencilBuffer&&(O|=n.STENCIL_BUFFER_BIT)),fe&&n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,se.__webglColorRenderbuffer[ge]),Me===!0&&(n.invalidateFramebuffer(n.READ_FRAMEBUFFER,[oe]),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[oe])),fe){const ie=i.get(g[ge]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,ie,0)}n.blitFramebuffer(0,0,w,W,0,0,w,W,O,n.NEAREST),u&&n.invalidateFramebuffer(n.READ_FRAMEBUFFER,G)}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),fe)for(let ge=0;ge<g.length;ge++){t.bindFramebuffer(n.FRAMEBUFFER,se.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.RENDERBUFFER,se.__webglColorRenderbuffer[ge]);const Me=i.get(g[ge]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,se.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ge,n.TEXTURE_2D,Me,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,se.__webglMultisampledFramebuffer)}}function X(x){return Math.min(r.maxSamples,x.samples)}function z(x){const g=i.get(x);return o&&x.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Q(x){const g=a.render.frame;c.get(x)!==g&&(c.set(x,g),x.update())}function te(x,g){const w=x.colorSpace,W=x.format,O=x.type;return x.isCompressedTexture===!0||x.isVideoTexture===!0||x.format===Ha||w!==Qn&&w!==an&&(it.getTransfer(w)===ft?o===!1?e.has("EXT_sRGB")===!0&&W===mn?(x.format=Ha,x.minFilter=Vt,x.generateMipmaps=!1):g=rd.sRGBToLinear(g):(W!==mn||O!==hi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",w)),g}this.allocateTextureUnit=I,this.resetTextureUnits=ne,this.setTexture2D=k,this.setTexture2DArray=ee,this.setTexture3D=Y,this.setTextureCube=re,this.rebindTextures=Be,this.setupRenderTarget=_,this.updateRenderTargetMipmap=U,this.updateMultisampleRenderTarget=N,this.setupDepthRenderbuffer=qe,this.setupFrameBufferTexture=we,this.useMultisampledRTT=z}function vS(n,e,t){const i=t.isWebGL2;function r(s,a=an){let o;const l=it.getTransfer(a);if(s===hi)return n.UNSIGNED_BYTE;if(s===Yf)return n.UNSIGNED_SHORT_4_4_4_4;if(s===jf)return n.UNSIGNED_SHORT_5_5_5_1;if(s===Jm)return n.BYTE;if(s===Qm)return n.SHORT;if(s===al)return n.UNSIGNED_SHORT;if(s===qf)return n.INT;if(s===ui)return n.UNSIGNED_INT;if(s===qn)return n.FLOAT;if(s===is)return i?n.HALF_FLOAT:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===eg)return n.ALPHA;if(s===mn)return n.RGBA;if(s===tg)return n.LUMINANCE;if(s===ng)return n.LUMINANCE_ALPHA;if(s===zi)return n.DEPTH_COMPONENT;if(s===yr)return n.DEPTH_STENCIL;if(s===Ha)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===ig)return n.RED;if(s===Kf)return n.RED_INTEGER;if(s===rg)return n.RG;if(s===Zf)return n.RG_INTEGER;if(s===Jf)return n.RGBA_INTEGER;if(s===$o||s===qo||s===Yo||s===jo)if(l===ft)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===$o)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===qo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Yo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===jo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===$o)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===qo)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Yo)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===jo)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===fc||s===dc||s===hc||s===pc)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===fc)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===dc)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===hc)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===pc)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Qf)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===mc||s===gc)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===mc)return l===ft?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===gc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===_c||s===vc||s===xc||s===Sc||s===yc||s===Mc||s===bc||s===Ec||s===Tc||s===Ac||s===wc||s===Rc||s===Cc||s===Lc)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===_c)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===vc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===xc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Sc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===yc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Mc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===bc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Ec)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Tc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Ac)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===wc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Rc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Cc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===Lc)return l===ft?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Ko||s===Pc||s===Dc)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===Ko)return l===ft?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Pc)return o.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Dc)return o.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===sg||s===Uc||s===Ic||s===Nc)if(o=e.get("EXT_texture_compression_rgtc"),o!==null){if(s===Ko)return o.COMPRESSED_RED_RGTC1_EXT;if(s===Uc)return o.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Ic)return o.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Nc)return o.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Bi?i?n.UNSIGNED_INT_24_8:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class xS extends on{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class ks extends Qt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const SS={type:"move"};class ya{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ks,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ks,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new H,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new H),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ks,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new H,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new H),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,u=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(u&&e.hand){a=!0;for(const M of e.hand.values()){const p=t.getJointPose(M,i),h=this._getHandJoint(u,M);p!==null&&(h.matrix.fromArray(p.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=p.radius),h.visible=p!==null}const c=u.joints["index-finger-tip"],f=u.joints["thumb-tip"],d=c.position.distanceTo(f.position),m=.02,y=.005;u.inputState.pinching&&d>m+y?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&d<=m-y&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),o.matrixWorldNeedsUpdate=!0,r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(SS)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new ks;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const yS=`
void main() {
...
}`;class bS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const r=new $t,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!=i.depthNear||t.depthFar!=i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}render(e,t){if(this.texture!==null){if(this.mesh===null){const i=t.cameras[0].viewport,r=new gi({extensions:{fragDepth:!0},vertexShader:yS,fragmentShader:MS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new gn(new Ao(20,20),r)}e.render(this.mesh,t)}}reset(){this.texture=null,this.mesh=null}}class ES extends Tr{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=1,u=null,c=null,f=null,d=null,m=null,y=null;const M=new bS,p=t.getContextAttributes();let h=null,E=null;const S=[],b=[],P=new je;let L=null;const C=new on;C.layers.enable(1),C.viewport=new wt;const q=new on;q.layers.enable(2),q.viewport=new wt;const K=[C,q],v=new xS;v.layers.enable(1),v.layers.enable(2);let A=null,F=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(J){let ce=S[J];return ce===void 0&&(ce=new ya,S[J]=ce),ce.getTargetRaySpace()},this.getControllerGrip=function(J){let ce=S[J];return ce===void 0&&(ce=new ya,S[J]=ce),ce.getGripSpace()},this.getHand=function(J){let ce=S[J];return ce===void 0&&(ce=new ya,S[J]=ce),ce.getHandSpace()};function ne(J){const ce=b.indexOf(J.inputSource);if(ce===-1)return;const ve=S[ce];ve!==void 0&&(ve.update(J.inputSource,J.frame,u||a),ve.dispatchEvent({type:J.type,data:J.inputSource}))}function I(){r.removeEventListener("select",ne),r.removeEventListener("selectstart",ne),r.removeEventListener("selectend",ne),r.removeEventListener("squeeze",ne),r.removeEventListener("squeezestart",ne),r.removeEventListener("squeezeend",ne),r.removeEventListener("end",I),r.removeEventListener("inputsourceschange",Z);for(let J=0;J<S.length;J++){const ce=b[J];ce!==null&&(b[J]=null,S[J].disconnect(ce))}A=null,F=null,M.reset(),e.setRenderTarget(h),m=null,d=null,f=null,r=null,E=null,Fe.stop(),i.isPresenting=!1,e.setPixelRatio(L),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(J){s=J,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(J){o=J,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||a},this.setReferenceSpace=function(J){u=J},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return f},this.getFrame=function(){return y},this.getSession=function(){return r},this.setSession=async function(J){if(r=J,r!==null){if(h=e.getRenderTarget(),r.addEventListener("select",ne),r.addEventListener("selectstart",ne),r.addEventListener("selectend",ne),r.addEventListener("squeeze",ne),r.addEventListener("squeezestart",ne),r.addEventListener("squeezeend",ne),r.addEventListener("end",I),r.addEventListener("inputsourceschange",Z),p.xrCompatible!==!0&&await t.makeXRCompatible(),L=e.getPixelRatio(),e.getSize(P),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const ce={antialias:r.renderState.layers===void 0?p.antialias:!0,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,t,ce),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),E=new Gi(m.framebufferWidth,m.framebufferHeight,{format:mn,type:hi,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil})}else{let ce=null,ve=null,we=null;p.depth&&(we=p.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ce=p.stencil?yr:zi,ve=p.stencil?Bi:ui);const Ce={colorFormat:t.RGBA8,depthFormat:we,scaleFactor:s};f=new XRWebGLBinding(r,t),d=f.createProjectionLayer(Ce),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),E=new Gi(d.textureWidth,d.textureHeight,{format:mn,type:hi,depthTexture:new _d(d.textureWidth,d.textureHeight,ve,void 0,void 0,void 0,void 0,void 0,void 0,ce),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0});const ye=e.properties.get(E);ye.__ignoreDepthValues=d.ignoreDepthValues}E.isXRRenderTarget=!0,this.setFoveation(l),u=null,a=await r.requestReferenceSpace(o),Fe.setContext(r),Fe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function Z(J){for(let ce=0;ce<J.removed.length;ce++){const ve=J.removed[ce],we=b.indexOf(ve);we>=0&&(b[we]=null,S[we].disconnect(ve))}for(let ce=0;ce<J.added.length;ce++){const ve=J.added[ce];let we=b.indexOf(ve);if(we===-1){for(let ye=0;ye<S.length;ye++)if(ye>=b.length){b.push(ve),we=ye;break}else if(b[ye]===null){b[ye]=ve,we=ye;break}if(we===-1)break}const Ce=S[we];Ce&&Ce.connect(ve)}}const k=new H,ee=new H;function Y(J,ce,ve){k.setFromMatrixPosition(ce.matrixWorld),ee.setFromMatrixPosition(ve.matrixWorld);const we=k.distanceTo(ee),Ce=ce.projectionMatrix.elements,ye=ve.projectionMatrix.elements,qe=Ce[14]/(Ce[10]-1),Be=Ce[14]/(Ce[10]+1),_=(Ce[9]+1)/Ce[5],U=(Ce[9]-1)/Ce[5],N=(Ce[8]-1)/Ce[0],X=(ye[8]+1)/ye[0],z=qe*N,Q=qe*X,te=we/(-N+X),x=te*-N;ce.matrixWorld.decompose(J.position,J.quaternion,J.scale),J.translateX(x),J.translateZ(te),J.matrixWorld.compose(J.position,J.quaternion,J.scale),J.matrixWorldInverse.copy(J.matrixWorld).invert();const g=qe+te,w=Be+te,W=z-x,O=Q+(we-x),G=_*Be/w*g,oe=U*Be/w*g;J.projectionMatrix.makePerspective(W,O,G,oe,g,w),J.projectionMatrixInverse.copy(J.projectionMatrix).invert()}function re(J,ce){ce===null?J.matrixWorld.copy(J.matrix):J.matrixWorld.multiplyMatrices(ce.matrixWorld,J.matrix),J.matrixWorldInverse.copy(J.matrixWorld).invert()}this.updateCamera=function(J){if(r===null)return;M.texture!==null&&(J.near=M.depthNear,J.far=M.depthFar),v.near=q.near=C.near=J.near,v.far=q.far=C.far=J.far,(A!==v.near||F!==v.far)&&(r.updateRenderState({depthNear:v.near,depthFar:v.far}),A=v.near,F=v.far,C.near=A,C.far=F,q.near=A,q.far=F,C.updateProjectionMatrix(),q.updateProjectionMatrix(),J.updateProjectionMatrix());const ce=J.parent,ve=v.cameras;re(v,ce);for(let we=0;we<ve.length;we++)re(ve[we],ce);ve.length===2?Y(v,C,q):v.projectionMatrix.copy(C.projectionMatrix),ae(J,v,ce)};function ae(J,ce,ve){ve===null?J.matrix.copy(ce.matrixWorld):(J.matrix.copy(ve.matrixWorld),J.matrix.invert(),J.matrix.multiply(ce.matrixWorld)),J.matrix.decompose(J.position,J.quaternion,J.scale),J.updateMatrixWorld(!0),J.projectionMatrix.copy(ce.projectionMatrix),J.projectionMatrixInverse.copy(ce.projectionMatrixInverse),J.isPerspectiveCamera&&(J.fov=Ga*2*Math.atan(1/J.projectionMatrix.elements[5]),J.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(J){l=J,d!==null&&(d.fixedFoveation=J),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=J)},this.hasDepthSensing=function(){return M.texture!==null};let ue=null;function de(J,ce){if(c=ce.getViewerPose(u||a),y=ce,c!==null){const ve=c.views;m!==null&&(e.setRenderTargetFramebuffer(E,m.framebuffer),e.setRenderTarget(E));let we=!1;ve.length!==v.cameras.length&&(v.cameras.length=0,we=!0);for(let ye=0;ye<ve.length;ye++){const qe=ve[ye];let Be=null;if(m!==null)Be=m.getViewport(qe);else{const U=f.getViewSubImage(d,qe);Be=U.viewport,ye===0&&(e.setRenderTargetTextures(E,U.colorTexture,d.ignoreDepthValues?void 0:U.depthStencilTexture),e.setRenderTarget(E))}let _=K[ye];_===void 0&&(_=new on,_.layers.enable(ye),_.viewport=new wt,K[ye]=_),_.matrix.fromArray(qe.transform.matrix),_.matrix.decompose(_.position,_.quaternion,_.scale),_.projectionMatrix.fromArray(qe.projectionMatrix),_.projectionMatrixInverse.copy(_.projectionMatrix).invert(),_.viewport.set(Be.x,Be.y,Be.width,Be.height),ye===0&&(v.matrix.copy(_.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),we===!0&&v.cameras.push(_)}const Ce=r.enabledFeatures;if(Ce&&Ce.includes("depth-sensing")){const ye=f.getDepthInformation(ve[0]);ye&&ye.isValid&&ye.texture&&M.init(e,ye,r.renderState)}}for(let ve=0;ve<S.length;ve++){const we=b[ve],Ce=S[ve];we!==null&&Ce!==void 0&&Ce.update(we,ce,u||a)}M.render(e,v),ue&&ue(J,ce),ce.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ce}),y=null}const Fe=new gd;Fe.setAnimationLoop(de),this.setAnimationLoop=function(J){ue=J},this.dispose=function(){}}}function TS(n,e){function t(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function i(p,h){h.color.getRGB(p.fogColor.value,dd(n)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function r(p,h,E,S,b){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(p,h):h.isMeshToonMaterial?(s(p,h),f(p,h)):h.isMeshPhongMaterial?(s(p,h),c(p,h)):h.isMeshStandardMaterial?(s(p,h),d(p,h),h.isMeshPhysicalMaterial&&m(p,h,b)):h.isMeshMatcapMaterial?(s(p,h),y(p,h)):h.isMeshDepthMaterial?s(p,h):h.isMeshDistanceMaterial?(s(p,h),M(p,h)):h.isMeshNormalMaterial?s(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?l(p,h,E,S):h.isSpriteMaterial?u(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,t(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===Xt&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,t(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===Xt&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,t(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,t(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const E=e.get(h).envMap;if(E&&(p.envMap.value=E,p.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap){p.lightMap.value=h.lightMap;const S=n._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=h.lightMapIntensity*S,t(h.lightMap,p.lightMapTransform)}h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function l(p,h,E,S){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*E,p.scale.value=S*.5,h.map&&(p.map.value=h.map,t(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function u(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function c(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function f(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function d(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,p.roughnessMapTransform)),e.get(h).envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function m(p,h,E){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Xt&&p.clearcoatNormalScale.value.negate())),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=E.texture,p.transmissionSamplerSize.value.set(E.width,E.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,p.specularIntensityMapTransform))}function y(p,h){h.matcap&&(p.matcap.value=h.matcap)}function M(p,h){const E=e.get(h).light;p.referencePosition.value.setFromMatrixPosition(E.matrixWorld),p.nearDistance.value=E.shadow.camera.near,p.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function AS(n,e,t,i){let r={},s={},a=[];const o=t.isWebGL2?n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(E,S){const b=S.program;i.uniformBlockBinding(E,b)}function u(E,S){let b=r[E.id];b===void 0&&(y(E),b=c(E),r[E.id]=b,E.addEventListener("dispose",p));const P=S.program;i.updateUBOMapping(E,P);const L=e.render.frame;s[E.id]!==L&&(d(E),s[E.id]=L)}function c(E){const S=f();E.__bindingPointIndex=S;const b=n.createBuffer(),P=E.__size,L=E.usage;return n.bindBuffer(n.UNIFORM_BUFFER,b),n.bufferData(n.UNIFORM_BUFFER,P,L),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,S,b),b}function f(){for(let E=0;E<o;E++)if(a.indexOf(E)===-1)return a.push(E),E;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(E){const S=r[E.id],b=E.uniforms,P=E.__cache;n.bindBuffer(n.UNIFORM_BUFFER,S);for(let L=0,C=b.length;L<C;L++){const q=Array.isArray(b[L])?b[L]:[b[L]];for(let K=0,v=q.length;K<v;K++){const A=q[K];if(m(A,L,K,P)===!0){const F=A.__offset,ne=Array.isArray(A.value)?A.value:[A.value];let I=0;for(let Z=0;Z<ne.length;Z++){const k=ne[Z],ee=M(k);typeof k=="number"||typeof k=="boolean"?(A.__data[0]=k,n.bufferSubData(n.UNIFORM_BUFFER,F+I,A.__data)):k.isMatrix3?(A.__data[0]=k.elements[0],A.__data[1]=k.elements[1],A.__data[2]=k.elements[2],A.__data[3]=0,A.__data[4]=k.elements[3],A.__data[5]=k.elements[4],A.__data[6]=k.elements[5],A.__data[7]=0,A.__data[8]=k.elements[6],A.__data[9]=k.elements[7],A.__data[10]=k.elements[8],A.__data[11]=0):(k.toArray(A.__data,I),I+=ee.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,F,A.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function m(E,S,b,P){const L=E.value,C=S+"_"+b;if(P[C]===void 0)return typeof L=="number"||typeof L=="boolean"?P[C]=L:P[C]=L.clone(),!0;{const q=P[C];if(typeof L=="number"||typeof L=="boolean"){if(q!==L)return P[C]=L,!0}else if(q.equals(L)===!1)return q.copy(L),!0}return!1}function y(E){const S=E.uniforms;let b=0;const P=16;for(let C=0,q=S.length;C<q;C++){const K=Array.isArray(S[C])?S[C]:[S[C]];for(let v=0,A=K.length;v<A;v++){const F=K[v],ne=Array.isArray(F.value)?F.value:[F.value];for(let I=0,Z=ne.length;I<Z;I++){const k=ne[I],ee=M(k),Y=b%P;Y!==0&&P-Y<ee.boundary&&(b+=P-Y),F.__data=new Float32Array(ee.storage/Float32Array.BYTES_PER_ELEMENT),F.__offset=b,b+=ee.storage}}}const L=b%P;return L>0&&(b+=P-L),E.__size=b,E.__cache={},this}function M(E){const S={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(S.boundary=4,S.storage=4):E.isVector2?(S.boundary=8,S.storage=8):E.isVector3||E.isColor?(S.boundary=16,S.storage=12):E.isVector4?(S.boundary=16,S.storage=16):E.isMatrix3?(S.boundary=48,S.storage=48):E.isMatrix4?(S.boundary=64,S.storage=64):E.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",E),S}function p(E){const S=E.target;S.removeEventListener("dispose",p);const b=a.indexOf(S.__bindingPointIndex);a.splice(b,1),n.deleteBuffer(r[S.id]),delete r[S.id],delete s[S.id]}function h(){for(const E in r)n.deleteBuffer(r[E]);a=[],r={},s={}}return{bind:l,update:u,dispose:h}}class bd{constructor(e={}){const{canvas:t=_g(),context:i=null,depth:r=!0,stencil:s=!0,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:c="default",failIfMajorPerformanceCaveat:f=!1}=e;this.isWebGLRenderer=!0;let d;i!==null?d=i.getContextAttributes().alpha:d=a;const m=new Uint32Array(4),y=new Int32Array(4);let M=null,p=null;const h=[],E=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=At,this._useLegacyLights=!1,this.toneMapping=di,this.toneMappingExposure=1;const S=this;let b=!1,P=0,L=0,C=null,q=-1,K=null;const v=new wt,A=new wt;let F=null;const ne=new st(0);let I=0,Z=t.width,k=t.height,ee=1,Y=null,re=null;const ae=new wt(0,0,Z,k),ue=new wt(0,0,Z,k);let de=!1;const Fe=new md;let J=!1,ce=!1,ve=null;const we=new Rt,Ce=new je,ye=new H,qe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Be(){return C===null?ee:1}let _=i;function U(T,B){for(let $=0;$<T.length;$++){const j=T[$],V=t.getContext(j,B);if(V!==null)return V}return null}try{const T={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:c,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ol}`),t.addEventListener("webglcontextlost",ot,!1),t.addEventListener("webglcontextrestored",R,!1),t.addEventListener("webglcontextcreationerror",he,!1),_===null){const B=["webgl2","webgl","experimental-webgl"];if(S.isWebGL1Renderer===!0&&B.shift(),_=U(B,T),_===null)throw U(B)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&_ instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),_.getShaderPrecisionFormat===void 0&&(_.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let N,X,z,Q,te,x,g,w,W,O,G,oe,se,fe,ge,Me,ie,Ve,Ie,Ue,Re,_e,Pe,Ke;function nt(){N=new Ux(_),X=new Ax(_,N,e),N.init(X),_e=new vS(_,N,X),z=new gS(_,N,X),Q=new Fx(_),te=new nS,x=new _S(_,N,z,te,X,_e,Q),g=new Rx(S),w=new Dx(S),W=new Vg(_,X),Pe=new Ex(_,N,W,X),O=new Ix(_,W,Q,Pe),G=new kx(_,O,W,Q),Ie=new zx(_,X,x),Me=new wx(te),oe=new tS(S,g,w,N,X,Pe,Me),se=new TS(S,te),fe=new rS,ge=new uS(N,X),Ve=new bx(S,g,w,z,G,d,l),ie=new mS(S,G,X),Ke=new AS(_,Q,X,z),Ue=new Tx(_,N,Q,X),Re=new Nx(_,N,Q,X),Q.programs=oe.programs,S.capabilities=X,S.extensions=N,S.properties=te,S.renderLists=fe,S.shadowMap=ie,S.state=z,S.info=Q}nt();const Ye=new ES(S,_);this.xr=Ye,this.getContext=function(){return _},this.getContextAttributes=function(){return _.getContextAttributes()},this.forceContextLoss=function(){const T=N.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=N.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return ee},this.setPixelRatio=function(T){T!==void 0&&(ee=T,this.setSize(Z,k,!1))},this.getSize=function(T){return T.set(Z,k)},this.setSize=function(T,B,$=!0){if(Ye.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Z=T,k=B,t.width=Math.floor(T*ee),t.height=Math.floor(B*ee),$===!0&&(t.style.width=T+"px",t.style.height=B+"px"),this.setViewport(0,0,T,B)},this.getDrawingBufferSize=function(T){return T.set(Z*ee,k*ee).floor()},this.setDrawingBufferSize=function(T,B,$){Z=T,k=B,ee=$,t.width=Math.floor(T*$),t.height=Math.floor(B*$),this.setViewport(0,0,T,B)},this.getCurrentViewport=function(T){return T.copy(v)},this.getViewport=function(T){return T.copy(ae)},this.setViewport=function(T,B,$,j){T.isVector4?ae.set(T.x,T.y,T.z,T.w):ae.set(T,B,$,j),z.viewport(v.copy(ae).multiplyScalar(ee).floor())},this.getScissor=function(T){return T.copy(ue)},this.setScissor=function(T,B,$,j){T.isVector4?ue.set(T.x,T.y,T.z,T.w):ue.set(T,B,$,j),z.scissor(A.copy(ue).multiplyScalar(ee).floor())},this.getScissorTest=function(){return de},this.setScissorTest=function(T){z.setScissorTest(de=T)},this.setOpaqueSort=function(T){Y=T},this.setTransparentSort=function(T){re=T},this.getClearColor=function(T){return T.copy(Ve.getClearColor())},this.setClearColor=function(){Ve.setClearColor.apply(Ve,arguments)},this.getClearAlpha=function(){return Ve.getClearAlpha()},this.setClearAlpha=function(){Ve.setClearAlpha.apply(Ve,arguments)},this.clear=function(T=!0,B=!0,$=!0){let j=0;if(T){let V=!1;if(C!==null){const xe=C.texture.format;V=xe===Jf||xe===Zf||xe===Kf}if(V){const xe=C.texture.type,Ae=xe===hi||xe===ui||xe===al||xe===Bi||xe===Yf||xe===jf,Ne=Ve.getClearColor(),Oe=Ve.getClearAlpha(),We=Ne.r,ze=Ne.g,He=Ne.b;Ae?(m[0]=We,m[1]=ze,m[2]=He,m[3]=Oe,_.clearBufferuiv(_.COLOR,0,m)):(y[0]=We,y[1]=ze,y[2]=He,y[3]=Oe,_.clearBufferiv(_.COLOR,0,y))}else j|=_.COLOR_BUFFER_BIT}B&&(j|=_.DEPTH_BUFFER_BIT),$&&(j|=_.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),_.clear(j)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ot,!1),t.removeEventListener("webglcontextrestored",R,!1),t.removeEventListener("webglcontextcreationerror",he,!1),fe.dispose(),ge.dispose(),te.dispose(),g.dispose(),w.dispose(),G.dispose(),Pe.dispose(),Ke.dispose(),oe.dispose(),Ye.dispose(),Ye.removeEventListener("sessionstart",en),Ye.removeEventListener("sessionend",ct),ve&&(ve.dispose(),ve=null),It.stop()};function ot(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),b=!0}function R(){console.log("THREE.WebGLRenderer: Context Restored."),b=!1;const T=Q.autoReset,B=ie.enabled,$=ie.autoUpdate,j=ie.needsUpdate,V=ie.type;nt(),Q.autoReset=T,ie.enabled=B,ie.autoUpdate=$,ie.needsUpdate=j,ie.type=V}function he(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function pe(T){const B=T.target;B.removeEventListener("dispose",pe),Ee(B)}function Ee(T){De(T),te.remove(T)}function De(T){const B=te.get(T).programs;B!==void 0&&(B.forEach(function($){oe.releaseProgram($)}),T.isShaderMaterial&&oe.releaseShaderCache(T))}this.renderBufferDirect=function(T,B,$,j,V,xe){B===null&&(B=qe);const Ae=V.isMesh&&V.matrixWorld.determinant()<0,Ne=Td(T,B,$,j,V);z.setMaterial(j,Ae);let Oe=$.index,We=1;if(j.wireframe===!0){if(Oe=O.getWireframeAttribute($),Oe===void 0)return;We=2}const ze=$.drawRange,He=$.attributes.position;let mt=ze.start*We,qt=(ze.start+ze.count)*We;xe!==null&&(mt=Math.max(mt,xe.start*We),qt=Math.min(qt,(xe.start+xe.count)*We)),Oe!==null?(mt=Math.max(mt,0),qt=Math.min(qt,Oe.count)):He!=null&&(mt=Math.max(mt,0),qt=Math.min(qt,He.count));const yt=qt-mt;if(yt<0||yt===1/0)return;Pe.setup(V,j,Ne,$,Oe);let Un,dt=Ue;if(Oe!==null&&(Un=W.get(Oe),dt=Re,dt.setIndex(Un)),V.isMesh)j.wireframe===!0?(z.setLineWidth(j.wireframeLinewidth*Be()),dt.setMode(_.LINES)):dt.setMode(_.TRIANGLES);else if(V.isLine){let Xe=j.linewidth;Xe===void 0&&(Xe=1),z.setLineWidth(Xe*Be()),V.isLineSegments?dt.setMode(_.LINES):V.isLineLoop?dt.setMode(_.LINE_LOOP):dt.setMode(_.LINE_STRIP)}else V.isPoints?dt.setMode(_.POINTS):V.isSprite&&dt.setMode(_.TRIANGLES);if(V.isBatchedMesh)dt.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else if(V.isInstancedMesh)dt.renderInstances(mt,yt,V.count);else if($.isInstancedBufferGeometry){const Xe=$._maxInstanceCount!==void 0?$._maxInstanceCount:1/0,Ro=Math.min($.instanceCount,Xe);dt.renderInstances(mt,yt,Ro)}else dt.render(mt,yt)};function tt(T,B,$){T.transparent===!0&&T.side===$n&&T.forceSinglePass===!1?(T.side=Xt,T.needsUpdate=!0,ms(T,B,$),T.side=mi,T.needsUpdate=!0,ms(T,B,$),T.side=$n):ms(T,B,$)}this.compile=function(T,B,$=null){$===null&&($=T),p=ge.get($),p.init(),E.push(p),$.traverseVisible(function(V){V.isLight&&V.layers.test(B.layers)&&(p.pushLight(V),V.castShadow&&p.pushShadow(V))}),T!==$&&T.traverseVisible(function(V){V.isLight&&V.layers.test(B.layers)&&(p.pushLight(V),V.castShadow&&p.pushShadow(V))}),p.setupLights(S._useLegacyLights);const j=new Set;return T.traverse(function(V){const xe=V.material;if(xe)if(Array.isArray(xe))for(let Ae=0;Ae<xe.length;Ae++){const Ne=xe[Ae];tt(Ne,$,V),j.add(Ne)}else tt(xe,$,V),j.add(xe)}),E.pop(),p=null,j},this.compileAsync=function(T,B,$=null){const j=this.compile(T,B,$);return new Promise(V=>{function xe(){if(j.forEach(function(Ae){te.get(Ae).currentProgram.isReady()&&j.delete(Ae)}),j.size===0){V(T);return}setTimeout(xe,10)}N.get("KHR_parallel_shader_compile")!==null?xe():setTimeout(xe,10)})};let lt=null;function Et(T){lt&&lt(T)}function en(){It.stop()}function ct(){It.start()}const It=new gd;It.setAnimationLoop(Et),typeof self<"u"&&It.setContext(self),this.setAnimationLoop=function(T){lt=T,Ye.setAnimationLoop(T),T===null?It.stop():It.start()},Ye.addEventListener("sessionstart",en),Ye.addEventListener("sessionend",ct),this.render=function(T,B){if(B!==void 0&&B.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(b===!0)return;T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),B.parent===null&&B.matrixWorldAutoUpdate===!0&&B.updateMatrixWorld(),Ye.enabled===!0&&Ye.isPresenting===!0&&(Ye.cameraAutoUpdate===!0&&Ye.updateCamera(B),B=Ye.getCamera()),T.isScene===!0&&T.onBeforeRender(S,T,B,C),p=ge.get(T,E.length),p.init(),E.push(p),we.multiplyMatrices(B.projectionMatrix,B.matrixWorldInverse),Fe.setFromProjectionMatrix(we),ce=this.localClippingEnabled,J=Me.init(this.clippingPlanes,ce),M=fe.get(T,h.length),M.init(),h.push(M),Sn(T,B,0,S.sortObjects),M.finish(),S.sortObjects===!0&&M.sort(Y,re),this.info.render.frame++,J===!0&&Me.beginShadows();const $=p.state.shadowsArray;if(ie.render($,T,B),J===!0&&Me.endShadows(),this.info.autoReset===!0&&this.info.reset(),(Ye.enabled===!1||Ye.isPresenting===!1||Ye.hasDepthSensing()===!1)&&Ve.render(M,T),p.setupLights(S._useLegacyLights),B.isArrayCamera){const j=B.cameras;for(let V=0,xe=j.length;V<xe;V++){const Ae=j[V];dl(M,T,Ae,Ae.viewport)}}else dl(M,T,B);C!==null&&(x.updateMultisampleRenderTarget(C),x.updateRenderTargetMipmap(C)),T.isScene===!0&&T.onAfterRender(S,T,B),Pe.resetDefaultState(),q=-1,K=null,E.pop(),E.length>0?p=E[E.length-1]:p=null,h.pop(),h.length>0?M=h[h.length-1]:M=null};function Sn(T,B,$,j){if(T.visible===!1)return;if(T.layers.test(B.layers)){if(T.isGroup)$=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(B);else if(T.isLight)p.pushLight(T),T.castShadow&&p.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||Fe.intersectsSprite(T)){j&&ye.setFromMatrixPosition(T.matrixWorld).applyMatrix4(we);const Ae=G.update(T),Ne=T.material;Ne.visible&&M.push(T,Ae,Ne,$,ye.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||Fe.intersectsObject(T))){const Ae=G.update(T),Ne=T.material;if(j&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),ye.copy(T.boundingSphere.center)):(Ae.boundingSphere===null&&Ae.computeBoundingSphere(),ye.copy(Ae.boundingSphere.center)),ye.applyMatrix4(T.matrixWorld).applyMatrix4(we)),Array.isArray(Ne)){const Oe=Ae.groups;for(let We=0,ze=Oe.length;We<ze;We++){const He=Oe[We],mt=Ne[He.materialIndex];mt&&mt.visible&&M.push(T,Ae,mt,$,ye.z,He)}}else Ne.visible&&M.push(T,Ae,Ne,$,ye.z,null)}}const xe=T.children;for(let Ae=0,Ne=xe.length;Ae<Ne;Ae++)Sn(xe[Ae],B,$,j)}function dl(T,B,$,j){const V=T.opaque,xe=T.transmissive,Ae=T.transparent;p.setupLightsView($),J===!0&&Me.setGlobalState(S.clippingPlanes,$),xe.length>0&&Ed(V,xe,B,$),j&&z.viewport(v.copy(j)),V.length>0&&ps(V,B,$),xe.length>0&&ps(xe,B,$),Ae.length>0&&ps(Ae,B,$),z.buffers.depth.setTest(!0),z.buffers.depth.setMask(!0),z.buffers.color.setMask(!0),z.setPolygonOffset(!1)}function Ed(T,B,$,j){if(($.isScene===!0?$.overrideMaterial:null)!==null)return;const xe=X.isWebGL2;ve===null&&(ve=new Gi(1,1,{generateMipmaps:!0,type:N.has("EXT_color_buffer_half_float")?is:hi,minFilter:Ii,samples:xe?4:0})),S.getDrawingBufferSize(Ce),xe?ve.setSize(Ce.x,Ce.y):ve.setSize(Va(Ce.x),Va(Ce.y));const Ae=S.getRenderTarget();S.setRenderTarget(ve),S.getClearColor(ne),I=S.getClearAlpha(),I<1&&S.setClearColor(16777215,.5),S.clear();const Ne=S.toneMapping;S.toneMapping=di,ps(T,$,j),x.updateMultisampleRenderTarget(ve),x.updateRenderTargetMipmap(ve);let Oe=!1;for(let We=0,ze=B.length;We<ze;We++){const He=B[We],mt=He.object,qt=He.geometry,yt=He.material,Un=He.group;if(yt.side===$n&&mt.layers.test(j.layers)){const dt=yt.side;yt.side=Xt,yt.needsUpdate=!0,hl(mt,$,j,qt,yt,Un),yt.side=dt,yt.needsUpdate=!0,Oe=!0}}Oe===!0&&(x.updateMultisampleRenderTarget(ve),x.updateRenderTargetMipmap(ve)),S.setRenderTarget(Ae),S.setClearColor(ne,I),S.toneMapping=Ne}function ps(T,B,$){const j=B.isScene===!0?B.overrideMaterial:null;for(let V=0,xe=T.length;V<xe;V++){const Ae=T[V],Ne=Ae.object,Oe=Ae.geometry,We=j===null?Ae.material:j,ze=Ae.group;Ne.layers.test($.layers)&&hl(Ne,B,$,Oe,We,ze)}}function hl(T,B,$,j,V,xe){T.onBeforeRender(S,B,$,j,V,xe),T.modelViewMatrix.multiplyMatrices($.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),V.onBeforeRender(S,B,$,j,T,xe),V.transparent===!0&&V.side===$n&&V.forceSinglePass===!1?(V.side=Xt,V.needsUpdate=!0,S.renderBufferDirect($,B,j,V,T,xe),V.side=mi,V.needsUpdate=!0,S.renderBufferDirect($,B,j,V,T,xe),V.side=$n):S.renderBufferDirect($,B,j,V,T,xe),T.onAfterRender(S,B,$,j,V,xe)}function ms(T,B,$){B.isScene!==!0&&(B=qe);const j=te.get(T),V=p.state.lights,xe=p.state.shadowsArray,Ae=V.state.version,Ne=oe.getParameters(T,V.state,xe,B,$),Oe=oe.getProgramCacheKey(Ne);let We=j.programs;j.environment=T.isMeshStandardMaterial?B.environment:null,j.fog=B.fog,j.envMap=(T.isMeshStandardMaterial?w:g).get(T.envMap||j.environment),We===void 0&&(T.addEventListener("dispose",pe),We=new Map,j.programs=We);let ze=We.get(Oe);if(ze!==void 0){if(j.currentProgram===ze&&j.lightsStateVersion===Ae)return ml(T,Ne),ze}else Ne.uniforms=oe.getUniforms(T),T.onBuild($,Ne,S),T.onBeforeCompile(Ne,S),ze=oe.acquireProgram(Ne,Oe),We.set(Oe,ze),j.uniforms=Ne.uniforms;const He=j.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(He.clippingPlanes=Me.uniform),ml(T,Ne),j.needsLights=wd(T),j.lightsStateVersion=Ae,j.needsLights&&(He.ambientLightColor.value=V.state.ambient,He.lightProbe.value=V.state.probe,He.directionalLights.value=V.state.directional,He.directionalLightShadows.value=V.state.directionalShadow,He.spotLights.value=V.state.spot,He.spotLightShadows.value=V.state.spotShadow,He.rectAreaLights.value=V.state.rectArea,He.ltc_1.value=V.state.rectAreaLTC1,He.ltc_2.value=V.state.rectAreaLTC2,He.pointLights.value=V.state.point,He.pointLightShadows.value=V.state.pointShadow,He.hemisphereLights.value=V.state.hemi,He.directionalShadowMap.value=V.state.directionalShadowMap,He.directionalShadowMatrix.value=V.state.directionalShadowMatrix,He.spotShadowMap.value=V.state.spotShadowMap,He.spotLightMatrix.value=V.state.spotLightMatrix,He.spotLightMap.value=V.state.spotLightMap,He.pointShadowMap.value=V.state.pointShadowMap,He.pointShadowMatrix.value=V.state.pointShadowMatrix),j.currentProgram=ze,j.uniformsList=null,ze}function pl(T){if(T.uniformsList===null){const B=T.currentProgram.getUniforms();T.uniformsList=Ws.seqWithValue(B.seq,T.uniforms)}return T.uniformsList}function ml(T,B){const $=te.get(T);$.outputColorSpace=B.outputColorSpace,$.batching=B.batching,$.instancing=B.instancing,$.instancingColor=B.instancingColor,$.skinning=B.skinning,$.morphTargets=B.morphTargets,$.morphNormals=B.morphNormals,$.morphColors=B.morphColors,$.morphTargetsCount=B.morphTargetsCount,$.numClippingPlanes=B.numClippingPlanes,$.numIntersection=B.numClipIntersection,$.vertexAlphas=B.vertexAlphas,$.vertexTangents=B.vertexTangents,$.toneMapping=B.toneMapping}function Td(T,B,$,j,V){B.isScene!==!0&&(B=qe),x.resetTextureUnits();const xe=B.fog,Ae=j.isMeshStandardMaterial?B.environment:null,Ne=C===null?S.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:Qn,Oe=(j.isMeshStandardMaterial?w:g).get(j.envMap||Ae),We=j.vertexColors===!0&&!!$.attributes.color&&$.attributes.color.itemSize===4,ze=!!$.attributes.tangent&&(!!j.normalMap||j.anisotropy>0),He=!!$.morphAttributes.position,mt=!!$.morphAttributes.normal,qt=!!$.morphAttributes.color;let yt=di;j.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(yt=S.toneMapping);const Un=$.morphAttributes.position||$.morphAttributes.normal||$.morphAttributes.color,dt=Un!==void 0?Un.length:0,Xe=te.get(j),Ro=p.state.lights;if(J===!0&&(ce===!0||T!==K)){const tn=T===K&&j.id===q;Me.setState(j,T,tn)}let pt=!1;j.version===Xe.__version?(Xe.needsLights&&Xe.lightsStateVersion!==Ro.state.version||Xe.outputColorSpace!==Ne||V.isBatchedMesh&&Xe.batching===!1||!V.isBatchedMesh&&Xe.batching===!0||V.isInstancedMesh&&Xe.instancing===!1||!V.isInstancedMesh&&Xe.instancing===!0||V.isSkinnedMesh&&Xe.skinning===!1||!V.isSkinnedMesh&&Xe.skinning===!0||V.isInstancedMesh&&Xe.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&Xe.instancingColor===!1&&V.instanceColor!==null||Xe.envMap!==Oe||j.fog===!0&&Xe.fog!==xe||Xe.numClippingPlanes!==void 0&&(Xe.numClippingPlanes!==Me.numPlanes||Xe.numIntersection!==Me.numIntersection)||Xe.vertexAlphas!==We||Xe.vertexTangents!==ze||Xe.morphTargets!==He||Xe.morphNormals!==mt||Xe.morphColors!==qt||Xe.toneMapping!==yt||X.isWebGL2===!0&&Xe.morphTargetsCount!==dt)&&(pt=!0):(pt=!0,Xe.__version=j.version);let vi=Xe.currentProgram;pt===!0&&(vi=ms(j,B,V));let gl=!1,wr=!1,Co=!1;const Ct=vi.getUniforms(),xi=Xe.uniforms;if(z.useProgram(vi.program)&&(gl=!0,wr=!0,Co=!0),j.id!==q&&(q=j.id,wr=!0),gl||K!==T){Ct.setValue(_,"projectionMatrix",T.projectionMatrix),Ct.setValue(_,"viewMatrix",T.matrixWorldInverse);const tn=Ct.map.cameraPosition;tn!==void 0&&tn.setValue(_,ye.setFromMatrixPosition(T.matrixWorld)),X.logarithmicDepthBuffer&&Ct.setValue(_,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(j.isMeshPhongMaterial||j.isMeshToonMaterial||j.isMeshLambertMaterial||j.isMeshBasicMaterial||j.isMeshStandardMaterial||j.isShaderMaterial)&&Ct.setValue(_,"isOrthographic",T.isOrthographicCamera===!0),K!==T&&(K=T,wr=!0,Co=!0)}if(V.isSkinnedMesh){Ct.setOptional(_,V,"bindMatrix"),Ct.setOptional(_,V,"bindMatrixInverse");const tn=V.skeleton;tn&&(X.floatVertexTextures?(tn.boneTexture===null&&tn.computeBoneTexture(),Ct.setValue(_,"boneTexture",tn.boneTexture,x)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}V.isBatchedMesh&&(Ct.setOptional(_,V,"batchingTexture"),Ct.setValue(_,"batchingTexture",V._matricesTexture,x));const Lo=$.morphAttributes;if((Lo.position!==void 0||Lo.normal!==void 0||Lo.color!==void 0&&X.isWebGL2===!0)&&Ie.update(V,$,vi),(wr||Xe.receiveShadow!==V.receiveShadow)&&(Xe.receiveShadow=V.receiveShadow,Ct.setValue(_,"receiveShadow",V.receiveShadow)),j.isMeshGouraudMaterial&&j.envMap!==null&&(xi.envMap.value=Oe,xi.flipEnvMap.value=Oe.isCubeTexture&&Oe.isRenderTargetTexture===!1?-1:1),wr&&(Ct.setValue(_,"toneMappingExposure",S.toneMappingExposure),Xe.needsLights&&Ad(xi,Co),xe&&j.fog===!0&&se.refreshFogUniforms(xi,xe),se.refreshMaterialUniforms(xi,j,ee,k,ve),Ws.upload(_,pl(Xe),xi,x)),j.isShaderMaterial&&j.uniformsNeedUpdate===!0&&(Ws.upload(_,pl(Xe),xi,x),j.uniformsNeedUpdate=!1),j.isSpriteMaterial&&Ct.setValue(_,"center",V.center),Ct.setValue(_,"modelViewMatrix",V.modelViewMatrix),Ct.setValue(_,"normalMatrix",V.normalMatrix),Ct.setValue(_,"modelMatrix",V.matrixWorld),j.isShaderMaterial||j.isRawShaderMaterial){const tn=j.uniformsGroups;for(let Po=0,Rd=tn.length;Po<Rd;Po++)if(X.isWebGL2){const _l=tn[Po];Ke.update(_l,vi),Ke.bind(_l,vi)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return vi}function Ad(T,B){T.ambientLightColor.needsUpdate=B,T.lightProbe.needsUpdate=B,T.directionalLights.needsUpdate=B,T.directionalLightShadows.needsUpdate=B,T.pointLights.needsUpdate=B,T.pointLightShadows.needsUpdate=B,T.spotLights.needsUpdate=B,T.spotLightShadows.needsUpdate=B,T.rectAreaLights.needsUpdate=B,T.hemisphereLights.needsUpdate=B}function wd(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return L},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(T,B,$){te.get(T.texture).__webglTexture=B,te.get(T.depthTexture).__webglTexture=$;const j=te.get(T);j.__hasExternalTextures=!0,j.__hasExternalTextures&&(j.__autoAllocateDepthBuffer=$===void 0,j.__autoAllocateDepthBuffer||N.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),j.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(T,B){const $=te.get(T);$.__webglFramebuffer=B,$.__useDefaultFramebuffer=B===void 0},this.setRenderTarget=function(T,B=0,$=0){C=T,P=B,L=$;let j=!0,V=null,xe=!1,Ae=!1;if(T){const Oe=te.get(T);Oe.__useDefaultFramebuffer!==void 0?(z.bindFramebuffer(_.FRAMEBUFFER,null),j=!1):Oe.__webglFramebuffer===void 0?x.setupRenderTarget(T):Oe.__hasExternalTextures&&x.rebindTextures(T,te.get(T.texture).__webglTexture,te.get(T.depthTexture).__webglTexture);const We=T.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(Ae=!0);const ze=te.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(ze[B])?V=ze[B][$]:V=ze[B],xe=!0):X.isWebGL2&&T.samples>0&&x.useMultisampledRTT(T)===!1?V=te.get(T).__webglMultisampledFramebuffer:Array.isArray(ze)?V=ze[$]:V=ze,v.copy(T.viewport),A.copy(T.scissor),F=T.scissorTest}else v.copy(ae).multiplyScalar(ee).floor(),A.copy(ue).multiplyScalar(ee).floor(),F=de;if(z.bindFramebuffer(_.FRAMEBUFFER,V)&&X.drawBuffers&&j&&z.drawBuffers(T,V),z.viewport(v),z.scissor(A),z.setScissorTest(F),xe){const Oe=te.get(T.texture);_.framebufferTexture2D(_.FRAMEBUFFER,_.COLOR_ATTACHMENT0,_.TEXTURE_CUBE_MAP_POSITIVE_X+B,Oe.__webglTexture,$)}else if(Ae){const Oe=te.get(T.texture),We=B||0;_.framebufferTextureLayer(_.FRAMEBUFFER,_.COLOR_ATTACHMENT0,Oe.__webglTexture,$||0,We)}q=-1},this.readRenderTargetPixels=function(T,B,$,j,V,xe,Ae){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ne=te.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ae!==void 0&&(Ne=Ne[Ae]),Ne){z.bindFramebuffer(_.FRAMEBUFFER,Ne);try{const Oe=T.texture,We=Oe.format,ze=Oe.type;if(We!==mn&&_e.convert(We)!==_.getParameter(_.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const He=ze===is&&(N.has("EXT_color_buffer_half_float")||X.isWebGL2&&N.has("EXT_color_buffer_float"));if(ze!==hi&&_e.convert(ze)!==_.getParameter(_.IMPLEMENTATION_COLOR_READ_TYPE)&&!(ze===qn&&(X.isWebGL2||N.has("OES_texture_float")||N.has("WEBGL_color_buffer_float")))&&!He){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}B>=0&&B<=T.width-j&&$>=0&&$<=T.height-V&&_.readPixels(B,$,j,V,_e.convert(We),_e.convert(ze),xe)}finally{const Oe=C!==null?te.get(C).__webglFramebuffer:null;z.bindFramebuffer(_.FRAMEBUFFER,Oe)}}},this.copyFramebufferToTexture=function(T,B,$=0){const j=Math.pow(2,-$),V=Math.floor(B.image.width*j),xe=Math.floor(B.image.height*j);x.setTexture2D(B,0),_.copyTexSubImage2D(_.TEXTURE_2D,$,0,0,T.x,T.y,V,xe),z.unbindTexture()},this.copyTextureToTexture=function(T,B,$,j=0){const V=B.image.width,xe=B.image.height,Ae=_e.convert($.format),Ne=_e.convert($.type);x.setTexture2D($,0),_.pixelStorei(_.UNPACK_FLIP_Y_WEBGL,$.flipY),_.pixelStorei(_.UNPACK_PREMULTIPLY_ALPHA_WEBGL,$.premultiplyAlpha),_.pixelStorei(_.UNPACK_ALIGNMENT,$.unpackAlignment),B.isDataTexture?_.texSubImage2D(_.TEXTURE_2D,j,T.x,T.y,V,xe,Ae,Ne,B.image.data):B.isCompressedTexture?_.compressedTexSubImage2D(_.TEXTURE_2D,j,T.x,T.y,B.mipmaps[0].width,B.mipmaps[0].height,Ae,B.mipmaps[0].data):_.texSubImage2D(_.TEXTURE_2D,j,T.x,T.y,Ae,Ne,B.image),j===0&&$.generateMipmaps&&_.generateMipmap(_.TEXTURE_2D),z.unbindTexture()},this.copyTextureToTexture3D=function(T,B,$,j,V=0){if(S.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const xe=T.max.x-T.min.x+1,Ae=T.max.y-T.min.y+1,Ne=T.max.z-T.min.z+1,Oe=_e.convert(j.format),We=_e.convert(j.type);let ze;if(j.isData3DTexture)x.setTexture3D(j,0),ze=_.TEXTURE_3D;else if(j.isDataArrayTexture||j.isCompressedArrayTexture)x.setTexture2DArray(j,0),ze=_.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}_.pixelStorei(_.UNPACK_FLIP_Y_WEBGL,j.flipY),_.pixelStorei(_.UNPACK_PREMULTIPLY_ALPHA_WEBGL,j.premultiplyAlpha),_.pixelStorei(_.UNPACK_ALIGNMENT,j.unpackAlignment);const He=_.getParameter(_.UNPACK_ROW_LENGTH),mt=_.getParameter(_.UNPACK_IMAGE_HEIGHT),qt=_.getParameter(_.UNPACK_SKIP_PIXELS),yt=_.getParameter(_.UNPACK_SKIP_ROWS),Un=_.getParameter(_.UNPACK_SKIP_IMAGES),dt=$.isCompressedTexture?$.mipmaps[V]:$.image;_.pixelStorei(_.UNPACK_ROW_LENGTH,dt.width),_.pixelStorei(_.UNPACK_IMAGE_HEIGHT,dt.height),_.pixelStorei(_.UNPACK_SKIP_PIXELS,T.min.x),_.pixelStorei(_.UNPACK_SKIP_ROWS,T.min.y),_.pixelStorei(_.UNPACK_SKIP_IMAGES,T.min.z),$.isDataTexture||$.isData3DTexture?_.texSubImage3D(ze,V,B.x,B.y,B.z,xe,Ae,Ne,Oe,We,dt.data):$.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),_.compressedTexSubImage3D(ze,V,B.x,B.y,B.z,xe,Ae,Ne,Oe,dt.data)):_.texSubImage3D(ze,V,B.x,B.y,B.z,xe,Ae,Ne,Oe,We,dt),_.pixelStorei(_.UNPACK_ROW_LENGTH,He),_.pixelStorei(_.UNPACK_IMAGE_HEIGHT,mt),_.pixelStorei(_.UNPACK_SKIP_PIXELS,qt),_.pixelStorei(_.UNPACK_SKIP_ROWS,yt),_.pixelStorei(_.UNPACK_SKIP_IMAGES,Un),V===0&&j.generateMipmaps&&_.generateMipmap(ze),z.unbindTexture()},this.initTexture=function(T){T.isCubeTexture?x.setTextureCube(T,0):T.isData3DTexture?x.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?x.setTexture2DArray(T,0):x.setTexture2D(T,0),z.unbindTexture()},this.resetState=function(){P=0,L=0,C=null,z.reset(),Pe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Yn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===ll?"display-p3":"srgb",t.unpackColorSpace=it.workingColorSpace===Eo?"display-p3":"srgb"}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===At?ki:ed}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===ki?At:Qn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class wS extends bd{}wS.prototype.isWebGL1Renderer=!0;class RS extends Qt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t}}class fl extends _i{constructor(e=[],t=[],i=1,r=0){super(),this.type="PolyhedronGeometry",this.parameters={vertices:e,indices:t,radius:i,detail:r};const s=[],a=[];o(r),u(i),c(),this.setAttribute("position",new Ln(s,3)),this.setAttribute("normal",new Ln(s.slice(),3)),this.setAttribute("uv",new Ln(a,2)),r===0?this.computeVertexNormals():this.normalizeNormals();function o(E){const S=new H,b=new H,P=new H;for(let L=0;L<t.length;L+=3)m(t[L+0],S),m(t[L+1],b),m(t[L+2],P),l(S,b,P,E)}function l(E,S,b,P){const L=P+1,C=[];for(let q=0;q<=L;q++){C[q]=[];const K=E.clone().lerp(b,q/L),v=S.clone().lerp(b,q/L),A=L-q;for(let F=0;F<=A;F++)F===0&&q===L?C[q][F]=K:C[q][F]=K.clone().lerp(v,F/A)}for(let q=0;q<L;q++)for(let K=0;K<2*(L-q)-1;K++){const v=Math.floor(K/2);K%2===0?(d(C[q][v+1]),d(C[q+1][v]),d(C[q][v])):(d(C[q][v+1]),d(C[q+1][v+1]),d(C[q+1][v]))}}function u(E){const S=new H;for(let b=0;b<s.length;b+=3)S.x=s[b+0],S.y=s[b+1],S.z=s[b+2],S.normalize().multiplyScalar(E),s[b+0]=S.x,s[b+1]=S.y,s[b+2]=S.z}function c(){const E=new H;for(let S=0;S<s.length;S+=3){E.x=s[S+0],E.y=s[S+1],E.z=s[S+2];const b=p(E)/2/Math.PI+.5,P=h(E)/Math.PI+.5;a.push(b,1-P)}y(),f()}function f(){for(let E=0;E<a.length;E+=6){const S=a[E+0],b=a[E+2],P=a[E+4],L=Math.max(S,b,P),C=Math.min(S,b,P);L>.9&&C<.1&&(S<.2&&(a[E+0]+=1),b<.2&&(a[E+2]+=1),P<.2&&(a[E+4]+=1))}}function d(E){s.push(E.x,E.y,E.z)}function m(E,S){const b=E*3;S.x=e[b+0],S.y=e[b+1],S.z=e[b+2]}function y(){const E=new H,S=new H,b=new H,P=new H,L=new je,C=new je,q=new je;for(let K=0,v=0;K<s.length;K+=9,v+=6){E.set(s[K+0],s[K+1],s[K+2]),S.set(s[K+3],s[K+4],s[K+5]),b.set(s[K+6],s[K+7],s[K+8]),L.set(a[v+0],a[v+1]),C.set(a[v+2],a[v+3]),q.set(a[v+4],a[v+5]),P.copy(E).add(S).add(b).divideScalar(3);const A=p(P);M(L,v+0,E,A),M(C,v+2,S,A),M(q,v+4,b,A)}}function M(E,S,b,P){P<0&&E.x===1&&(a[S]=E.x-1),b.x===0&&b.z===0&&(a[S]=P/2/Math.PI+.5)}function p(E){return Math.atan2(E.z,-E.x)}function h(E){return Math.atan2(-E.y,Math.sqrt(E.x*E.x+E.z*E.z))}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new fl(e.vertices,e.indices,e.radius,e.details)}}class ao extends fl{constructor(e=1,t=0){const i=(1+Math.sqrt(5))/2,r=[-1,i,0,1,i,0,-1,-i,0,1,-i,0,0,-1,i,0,1,i,0,-1,-i,0,1,-i,i,0,-1,i,0,1,-i,0,-1,-i,0,1],s=[0,11,5,0,5,1,0,1,7,0,7,10,0,10,11,1,5,9,5,11,4,11,10,2,10,7,6,7,1,8,3,9,4,3,4,2,3,2,6,3,6,8,3,8,9,4,9,5,2,4,11,6,2,10,8,6,7,9,8,1];super(r,s,e,t),this.type="IcosahedronGeometry",this.parameters={radius:e,detail:t}}static fromJSON(e){return new ao(e.radius,e.detail)}}class Au extends ds{constructor(e){super(),this.isMeshNormalMaterial=!0,this.type="MeshNormalMaterial",this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=td,this.normalScale=new je(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.flatShading=!1,this.setValues(e)}copy(e){return super.copy(e),this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.flatShading=e.flatShading,this}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:ol}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=ol);const wu=768,CS={__name:"HeroBackground",setup(n){const e=Hi(null);let t,i,r,s,a,o=0,l=0,u=0,c=0;const f=typeof window<"u"&&("ontouchstart"in window||navigator.maxTouchPoints>0),d=()=>{const p=e.value;if(!p||!t||!r)return;const h=p.clientWidth||window.innerWidth,E=p.clientHeight||window.innerHeight,S=h<wu;if(t.setSize(h,E),r.aspect=h/E,r.fov=S?80:75,r.position.z=S?6.5:5,r.updateProjectionMatrix(),s&&a){const b=S?.85:1,P=S?.65:1;s.scale.set(b,b,b),a.scale.set(P,P,P)}},m=(p,h)=>{u=(p/window.innerWidth-.5)*2,c=(h/window.innerHeight-.5)*2},y=p=>m(p.clientX,p.clientY),M=p=>{const h=p.touches[0];h&&m(h.clientX,h.clientY)};return os(()=>{const p=e.value,h=p.clientWidth||window.innerWidth,E=p.clientHeight||window.innerHeight,S=new RS;r=new on(75,h/E,.1,1e3),r.position.z=5,t=new bd({alpha:!0,antialias:!0}),t.setSize(h,E),t.setPixelRatio(Math.min(window.devicePixelRatio,2)),p.appendChild(t.domElement),s=new gn(new ao(2,1),new Au({wireframe:!0,transparent:!0,opacity:.3})),S.add(s),a=new gn(new ao(1,0),new Au({wireframe:!1,transparent:!0,opacity:.8})),S.add(a),d(),window.addEventListener("mousemove",y),f&&window.addEventListener("touchmove",M,{passive:!0}),window.addEventListener("resize",d);const b=()=>{i=requestAnimationFrame(b),o+=(u-o)*.05,l+=(c-l)*.05,s.rotation.x+=.005,s.rotation.y+=.008,s.rotation.z+=.003,a.rotation.x-=.01,a.rotation.y-=.012;const P=window.innerWidth<wu?.35:.5;s.position.x=o*P,s.position.y=-l*P,a.position.x=o*P*1.2,a.position.y=-l*P*1.2,t.render(S,r)};b(),as(()=>{cancelAnimationFrame(i),t.dispose(),window.removeEventListener("mousemove",y),f&&window.removeEventListener("touchmove",M),window.removeEventListener("resize",d)})}),(p,h)=>(be(),Te("div",{ref_key:"container",ref:e,class:"absolute inset-0 w-full h-full pointer-events-none hero-background"},null,512))}},LS=sl(CS,[["__scopeId","data-v-0bece295"]]),PS={class:"min-h-screen flex flex-col items-center justify-center px-gutter py-section-padding-v-mobile md:py-section-padding-v relative overflow-hidden mesh-gradient"},DS={class:"max-w-container-max mx-auto text-center z-10"},US={class:"inline-flex items-center gap-2 px-3 py-1.5 rounded-md glass-panel mb-8 border-primary/10"},IS={class:"text-label-sm text-primary uppercase tracking-widest font-bold"},NS={class:"font-display-xl-mobile md:font-display-xl text-display-xl-mobile md:text-display-xl leading-tight mb-6 max-w-4xl mx-auto tracking-tighter"},FS={class:"text-gradient"},OS={class:"font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto mb-10 opacity-80"},BS={class:"flex flex-col md:flex-row gap-4 justify-center items-center"},zS={href:"#iletisim",class:"w-full md:w-auto px-10 py-4 bg-primary text-white rounded-lg font-label-md glow-button"},kS={href:"#hizmetler",class:"w-full md:w-auto px-10 py-4 glass-panel text-white rounded-lg font-label-md hover:bg-white/5 transition-all border-white/10"},HS={class:"mt-20 relative w-full max-w-5xl mx-auto px-4 perspective-1000"},GS={class:"glass-panel p-6 md:p-8 rounded-xl border-white/10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] transform rotate-x-2 transition-transform duration-700 hover:rotate-x-0"},VS={class:"flex items-center justify-between mb-8 border-b border-white/5 pb-4"},WS={class:"flex items-center gap-3"},XS={class:"text-[10px] uppercase tracking-[0.18em] text-on-surface-variant"},$S={class:"grid min-h-[250px] grid-cols-1 gap-8 md:grid-cols-[0.8fr_1.2fr] md:items-center"},qS={class:"order-2 md:order-1"},YS={class:"text-[10px] font-bold uppercase tracking-[0.24em] text-primary"},jS={class:"max-w-md text-2xl font-semibold tracking-tight text-white md:text-3xl"},KS={class:"max-w-md text-sm leading-relaxed text-on-surface-variant"},ZS={class:"flex flex-wrap gap-2 pt-2"},JS={class:"order-1 relative h-56 overflow-hidden rounded-lg border border-white/10 bg-white/[0.03] md:order-2"},QS={class:"mb-5 flex items-center justify-between text-[10px] uppercase tracking-[0.16em] text-on-surface-variant"},ey={class:"text-primary"},ty={class:"flex h-[170px] items-end gap-2"},ny={class:"mt-7 flex items-center justify-between border-t border-white/5 pt-5"},iy=["aria-label"],ry=["aria-selected","aria-label","onClick"],sy={class:"flex gap-2"},oy=["aria-label"],ay=["aria-label"],ly={__name:"HeroSection",setup(n){const{t:e}=Dn(),t=Hi(0);let i;const r=Jt(()=>[{eyebrow:e("hero.carouselSlides.results.eyebrow"),title:e("hero.carouselSlides.results.title"),description:e("hero.carouselSlides.results.description"),visualLabel:e("hero.carouselSlides.results.visualLabel"),tags:["ERP","Automation","+42%"],bars:[38,48,44,66,72,88,96]},{eyebrow:e("hero.carouselSlides.ai.eyebrow"),title:e("hero.carouselSlides.ai.title"),description:e("hero.carouselSlides.ai.description"),visualLabel:e("hero.carouselSlides.ai.visualLabel"),tags:["AI","LLM","10x"],bars:[28,62,42,78,55,90,84]},{eyebrow:e("hero.carouselSlides.stack.eyebrow"),title:e("hero.carouselSlides.stack.title"),description:e("hero.carouselSlides.stack.description"),visualLabel:e("hero.carouselSlides.stack.visualLabel"),tags:["Cloud","DevOps","99.9%"],bars:[72,58,82,64,92,76,98]}]),s=Jt(()=>r.value[t.value]);function a(u){t.value=u}function o(){t.value=(t.value+1)%r.value.length}function l(){t.value=(t.value-1+r.value.length)%r.value.length}return os(()=>{i=window.setInterval(o,5e3)}),as(()=>window.clearInterval(i)),(u,c)=>(be(),Te("section",PS,[rt(LS),D("div",DS,[D("div",US,[D("span",IS,le(Se(e)("hero.badge")),1)]),D("h1",NS,[vt(le(Se(e)("hero.title1"))+" ",1),D("span",FS,le(Se(e)("hero.titleHighlight")),1),vt(" "+le(Se(e)("hero.title2")),1)]),D("p",OS,le(Se(e)("hero.subtitle")),1),D("div",BS,[D("a",zS,le(Se(e)("hero.ctaPrimary")),1),D("a",kS,le(Se(e)("hero.ctaSecondary")),1)])]),D("div",HS,[D("div",GS,[D("div",VS,[c[1]||(c[1]=D("div",{class:"flex gap-2"},[D("div",{class:"w-2.5 h-2.5 rounded-full bg-white/20"}),D("div",{class:"w-2.5 h-2.5 rounded-full bg-white/10"}),D("div",{class:"w-2.5 h-2.5 rounded-full bg-primary/40"})],-1)),D("div",WS,[D("span",XS,le(Se(e)("hero.carouselLabel")),1),c[0]||(c[0]=D("span",{class:"flex items-center gap-1.5 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1.5 text-[10px] uppercase tracking-[0.18em] text-emerald-300"},[D("span",{class:"h-1.5 w-1.5 animate-pulse rounded-full bg-emerald-300"}),vt(" LIVE ")],-1))])]),D("div",$S,[D("div",qS,[rt(Ia,{name:"carousel-fade",mode:"out-in"},{default:Ys(()=>[(be(),Te("div",{key:t.value,class:"space-y-4"},[D("span",YS,le(s.value.eyebrow),1),D("h2",jS,le(s.value.title),1),D("p",KS,le(s.value.description),1),D("div",ZS,[(be(!0),Te(Qe,null,_t(s.value.tags,f=>(be(),Te("span",{key:f,class:"rounded-full border border-white/10 bg-white/[0.04] px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-white/70"},le(f),1))),128))])]))]),_:1})]),D("div",JS,[rt(Ia,{name:"carousel-fade",mode:"out-in"},{default:Ys(()=>[(be(),Te("div",{key:t.value,class:"absolute inset-0 p-5"},[D("div",QS,[D("span",null,le(s.value.visualLabel),1),D("span",ey,le(String(t.value+1).padStart(2,"0"))+" / 03",1)]),D("div",ty,[(be(!0),Te(Qe,null,_t(s.value.bars,(f,d)=>(be(),Te("span",{key:d,class:"flex-1 rounded-t-sm bg-gradient-to-t from-primary/30 to-primary transition-all duration-700",style:po({height:`${f}%`})},null,4))),128))]),c[2]||(c[2]=D("div",{class:"absolute inset-x-5 bottom-5 border-t border-white/10"},null,-1))]))]),_:1})])]),D("div",ny,[D("div",{class:"flex gap-2",role:"tablist","aria-label":Se(e)("hero.carouselLabel")},[(be(!0),Te(Qe,null,_t(r.value,(f,d)=>(be(),Te("button",{key:f.title,type:"button",role:"tab","aria-selected":t.value===d,"aria-label":f.title,class:Kt(["h-1.5 rounded-full transition-all duration-300",t.value===d?"w-8 bg-primary":"w-2 bg-white/20 hover:bg-white/40"]),onClick:m=>a(d)},null,10,ry))),128))],8,iy),D("div",sy,[D("button",{type:"button","aria-label":Se(e)("hero.carouselPrevious"),class:"flex h-8 w-8 items-center justify-center rounded-lg border border-white/10 text-white/70 transition-colors hover:border-primary/40 hover:text-primary",onClick:l},[...c[3]||(c[3]=[D("span",{class:"material-symbols-outlined text-[18px]"},"arrow_back",-1)])],8,oy),D("button",{type:"button","aria-label":Se(e)("hero.carouselNext"),class:"flex h-8 w-8 items-center justify-center rounded-lg border border-white/10 text-white/70 transition-colors hover:border-primary/40 hover:text-primary",onClick:o},[...c[4]||(c[4]=[D("span",{class:"material-symbols-outlined text-[18px]"},"arrow_forward",-1)])],8,ay)])])])])]))}},cy=sl(ly,[["__scopeId","data-v-3ce0e86f"]]),uy={id:"teknolojiler",class:"px-gutter py-section-padding-v-mobile md:py-section-padding-v bg-surface-container-lowest/30"},fy={class:"max-w-container-max mx-auto"},dy={class:"flex flex-col md:flex-row justify-between items-end mb-16 gap-6"},hy={class:"max-w-2xl"},py={class:"font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-4 text-white"},my={class:"text-body-lg text-on-surface-variant"},gy=["aria-label"],_y=["aria-selected","onClick"],vy={class:"relative w-full overflow-hidden flex flex-col gap-6 rounded-2xl"},xy={class:"carousel-track py-2"},Sy={class:"flex gap-6 pr-6"},yy={class:"absolute top-2 right-2 text-[9px] uppercase tracking-wider font-semibold px-1.5 py-0.5 rounded bg-white/5"},My={class:"material-symbols-outlined text-4xl mt-2 transition-colors"},by={class:"text-sm font-mono font-medium transition-colors"},Ey={class:"flex gap-6 pr-6"},Ty={class:"absolute top-2 right-2 text-[9px] uppercase tracking-wider font-semibold px-1.5 py-0.5 rounded bg-white/5"},Ay={class:"material-symbols-outlined text-4xl mt-2 transition-colors"},wy={class:"text-sm font-mono font-medium transition-colors"},Ry={class:"carousel-track-reverse py-2"},Cy={class:"flex gap-6 pr-6"},Ly={class:"absolute top-2 right-2 text-[9px] uppercase tracking-wider font-semibold px-1.5 py-0.5 rounded bg-white/5"},Py={class:"material-symbols-outlined text-4xl mt-2 transition-colors"},Dy={class:"text-sm font-mono font-medium transition-colors"},Uy={class:"flex gap-6 pr-6"},Iy={class:"absolute top-2 right-2 text-[9px] uppercase tracking-wider font-semibold px-1.5 py-0.5 rounded bg-white/5"},Ny={class:"material-symbols-outlined text-4xl mt-2 transition-colors"},Fy={class:"text-sm font-mono font-medium transition-colors"},Oy={__name:"TechEcosystem",setup(n){const{t:e}=Dn(),t=Hi("all"),i=Jt(()=>[{key:"all",label:e("ecosystem.categoryAll")},{key:"Frontend",label:"Frontend"},{key:"Backend",label:"Backend"},{key:"DevOps",label:"DevOps"},{key:"AI",label:"AI"}]),r=[{name:"Vue.js",icon:"code_blocks",category:"Frontend"},{name:"React",icon:"deployed_code",category:"Frontend"},{name:"TailwindCSS",icon:"palette",category:"Frontend"},{name:"TypeScript",icon:"data_object",category:"Frontend"},{name:"Flutter",icon:"flutter",category:"Frontend"},{name:"Node.js",icon:"terminal",category:"Backend"},{name:"Spring Boot",icon:"coffee",category:"Backend"},{name:"PostgreSQL",icon:"database",category:"Backend"},{name:"MySQL",icon:"database",category:"Backend"},{name:"Express.js",icon:"terminal",category:"Backend"},{name:"RabbitMQ",icon:"message",category:"Backend"}],s=[{name:"Docker",icon:"grid_view",category:"DevOps"},{name:"Kubernetes",icon:"hub",category:"DevOps"},{name:"AWS / Cloud",icon:"cloud",category:"DevOps"},{name:"Git / GitHub",icon:"code",category:"DevOps"},{name:"Linux",icon:"computer",category:"DevOps"},{name:"PyTorch",icon:"psychology",category:"AI"},{name:"LLM Engine",icon:"smart_toy",category:"AI"},{name:"OpenAI API",icon:"integration_instructions",category:"AI"}],a=[...r,...s],o=Jt(()=>t.value==="all"?a:a.filter(u=>u.category===t.value));function l(u){switch(u){case"Frontend":return"bg-blue-500/5 hover:bg-blue-500/10 border-blue-500/20 text-blue-300 hover:border-blue-400";case"Backend":return"bg-emerald-500/5 hover:bg-emerald-500/10 border-emerald-500/20 text-emerald-300 hover:border-emerald-400";case"DevOps":return"bg-purple-500/5 hover:bg-purple-500/10 border-purple-500/20 text-purple-300 hover:border-purple-400";case"AI":return"bg-amber-500/5 hover:bg-amber-500/10 border-amber-500/20 text-amber-300 hover:border-amber-400";default:return"bg-white/5 border-white/10 text-on-surface-variant hover:border-primary"}}return(u,c)=>(be(),Te("section",uy,[D("div",fy,[D("div",dy,[D("div",hy,[D("h2",py,le(Se(e)("ecosystem.title")),1),D("p",my,le(Se(e)("ecosystem.subtitle")),1)]),c[0]||(c[0]=D("div",{class:"hidden md:block"},[D("span",{class:"material-symbols-outlined text-[64px] text-primary/10"},"layers")],-1))]),D("div",{class:"mb-8 flex flex-wrap gap-2",role:"tablist","aria-label":Se(e)("ecosystem.categoriesLabel")},[(be(!0),Te(Qe,null,_t(i.value,f=>(be(),Te("button",{key:f.key,type:"button",role:"tab","aria-selected":t.value===f.key,class:Kt(["rounded-lg border px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] transition-colors",t.value===f.key?"border-primary bg-primary/10 text-primary":"border-white/10 text-on-surface-variant hover:border-white/30 hover:text-white"]),onClick:d=>t.value=f.key},le(f.label),11,_y))),128))],8,gy),D("div",vy,[c[1]||(c[1]=D("div",{class:"absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-[#121317] to-transparent z-10 pointer-events-none"},null,-1)),c[2]||(c[2]=D("div",{class:"absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-[#121317] to-transparent z-10 pointer-events-none"},null,-1)),D("div",xy,[D("div",Sy,[(be(!0),Te(Qe,null,_t(o.value,(f,d)=>(be(),Te("div",{key:"row1-orig-"+d,class:Kt(["w-44 h-32 rounded-xl border flex items-center justify-center flex-col gap-2 transition-all duration-300 group relative overflow-hidden px-4 flex-shrink-0",l(f.category)])},[D("span",yy,le(f.category),1),D("span",My,le(f.icon),1),D("span",by,le(f.name),1)],2))),128))]),D("div",Ey,[(be(!0),Te(Qe,null,_t(o.value,(f,d)=>(be(),Te("div",{key:"row1-dup-"+d,class:Kt(["w-44 h-32 rounded-xl border flex items-center justify-center flex-col gap-2 transition-all duration-300 group relative overflow-hidden px-4 flex-shrink-0",l(f.category)])},[D("span",Ty,le(f.category),1),D("span",Ay,le(f.icon),1),D("span",wy,le(f.name),1)],2))),128))])]),D("div",Ry,[D("div",Cy,[(be(!0),Te(Qe,null,_t(o.value,(f,d)=>(be(),Te("div",{key:"row2-orig-"+d,class:Kt(["w-44 h-32 rounded-xl border flex items-center justify-center flex-col gap-2 transition-all duration-300 group relative overflow-hidden px-4 flex-shrink-0",l(f.category)])},[D("span",Ly,le(f.category),1),D("span",Py,le(f.icon),1),D("span",Dy,le(f.name),1)],2))),128))]),D("div",Uy,[(be(!0),Te(Qe,null,_t(o.value,(f,d)=>(be(),Te("div",{key:"row2-dup-"+d,class:Kt(["w-44 h-32 rounded-xl border flex items-center justify-center flex-col gap-2 transition-all duration-300 group relative overflow-hidden px-4 flex-shrink-0",l(f.category)])},[D("span",Iy,le(f.category),1),D("span",Ny,le(f.icon),1),D("span",Fy,le(f.name),1)],2))),128))])])])])]))}},By={id:"hizmetler",class:"px-gutter py-section-padding-v-mobile md:py-section-padding-v bg-surface-container-lowest/30"},zy={class:"max-w-container-max mx-auto"},ky={class:"flex flex-col md:flex-row justify-between items-end mb-16 gap-6"},Hy={class:"max-w-2xl"},Gy={class:"font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-4 text-white"},Vy={class:"text-primary"},Wy={class:"text-body-lg text-on-surface-variant"},Xy={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"},$y={class:"w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6 border border-primary/20"},qy={class:"material-symbols-outlined text-primary text-2xl"},Yy={class:"text-headline-md text-[20px] mb-4 text-white"},jy={class:"text-on-surface-variant text-body-md mb-6 leading-relaxed"},Ky={href:"#iletisim",class:"inline-flex items-center text-primary font-label-md gap-2 group-hover:translate-x-1 transition-transform"},Zy={__name:"ServicesSection",setup(n){const{t:e,messages:t,locale:i}=Dn(),r=["devices","hub","code_blocks","auto_awesome"],s=Jt(()=>t[i.value].services.cards.map((a,o)=>({icon:r[o],...a})));return(a,o)=>(be(),Te("section",By,[D("div",zy,[D("div",ky,[D("div",Hy,[D("h2",Gy,[vt(le(Se(e)("services.sectionTitle1"))+" ",1),D("span",Vy,le(Se(e)("services.sectionTitleHighlight")),1)]),D("p",Wy,le(Se(e)("services.sectionSubtitle")),1)]),o[0]||(o[0]=D("div",{class:"hidden md:block"},[D("span",{class:"material-symbols-outlined text-[64px] text-primary/10"},"terminal")],-1))]),D("div",Xy,[(be(!0),Te(Qe,null,_t(s.value,(l,u)=>(be(),Te("div",{key:u,class:"glass-panel p-8 rounded-xl hover:border-primary/30 transition-all duration-300 group"},[D("div",$y,[D("span",qy,le(l.icon),1)]),D("h3",Yy,le(l.title),1),D("p",jy,le(l.description),1),D("a",Ky,[vt(le(Se(e)("services.details"))+" ",1),o[1]||(o[1]=D("span",{class:"material-symbols-outlined text-sm"},"arrow_forward_ios",-1))])]))),128))])])]))}},Jy={class:"px-gutter py-section-padding-v-mobile md:py-section-padding-v relative overflow-hidden"},Qy={class:"max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center"},eM={class:"relative"},tM={class:"glass-panel p-2 rounded-xl relative z-10 overflow-hidden border-white/10"},nM={class:"absolute bottom-10 left-10 right-10 glass-panel p-6 rounded-lg border-white/10 bg-surface-obsidian/40"},iM={class:"flex items-center gap-4 mb-3"},rM={class:"text-label-sm font-bold tracking-widest text-white uppercase"},sM={class:"text-label-md text-on-surface-variant italic font-medium"},oM={class:"font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-8 text-white tracking-tight"},aM={class:"text-gradient"},lM={class:"space-y-8"},cM={class:"flex-shrink-0 w-10 h-10 rounded-md glass-panel flex items-center justify-center border-white/10"},uM={class:"material-symbols-outlined text-primary text-xl"},fM={class:"font-headline-md text-[18px] mb-2 text-white"},dM={class:"text-on-surface-variant text-sm leading-relaxed"},hM={__name:"AiSection",setup(n){const{t:e,messages:t,locale:i}=Dn(),r=["psychology","bolt","security"],s=Jt(()=>t[i.value].ai.features.map((a,o)=>({icon:r[o],...a})));return(a,o)=>(be(),Te("section",Jy,[D("div",Qy,[D("div",eM,[o[2]||(o[2]=D("div",{class:"absolute -inset-10 bg-primary/5 blur-[120px] rounded-full"},null,-1)),D("div",tM,[o[1]||(o[1]=D("div",{class:"bg-surface-obsidian rounded-lg p-1 overflow-hidden h-[500px]"},[D("img",{class:"w-full h-full object-cover rounded-md opacity-60 grayscale hover:grayscale-0 transition-all duration-1000",src:"https://lh3.googleusercontent.com/aida-public/AB6AXuCfpCUN3OlvCZ5mhdfKYSRH7hUB6OFv5FoonzdxU_q5wSwVW9YtlweLnhEESIEAql596fl4Hyezdy2u7LGOx6-HX8Ux74572JLO5fkdSffV-HRWTSQsEpwJghvzob1KPAnVOH31PtseoOX4ENZA4qSY4BsPdKxAOgUuoLCLlIkC8stgpCIWtTo5TzBgC2_yWLoeF-99NBvFerlLfsGRbiz-lEvWOarpdwwIEcaoDnJ8jVJSn2cxx4LI",alt:"AI Engine"})],-1)),D("div",nM,[D("div",iM,[o[0]||(o[0]=D("div",{class:"w-1.5 h-1.5 rounded-full bg-primary animate-pulse"},null,-1)),D("span",rM,le(Se(e)("ai.engineLabel")),1)]),D("p",sM,le(Se(e)("ai.engineQuote")),1)])])]),D("div",null,[D("h2",oM,[vt(le(Se(e)("ai.title1"))+" ",1),D("span",aM,le(Se(e)("ai.titleHighlight")),1),vt(" "+le(Se(e)("ai.title2")),1)]),D("div",lM,[(be(!0),Te(Qe,null,_t(s.value,(l,u)=>(be(),Te("div",{key:u,class:"flex gap-6"},[D("div",cM,[D("span",uM,le(l.icon),1)]),D("div",null,[D("h4",fM,le(l.title),1),D("p",dM,le(l.description),1)])]))),128))])])])]))}},pM={class:"px-gutter py-24 bg-primary/5 border-y border-primary/10"},mM={class:"max-w-container-max mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center"},gM={class:"text-label-md uppercase tracking-widest text-primary font-bold"},_M={class:"text-label-md uppercase tracking-widest text-primary font-bold"},vM={class:"text-label-md uppercase tracking-widest text-primary font-bold"},xM={__name:"StatsSection",setup(n){const{t:e}=Dn();return(t,i)=>(be(),Te("section",pM,[D("div",mM,[D("div",null,[i[0]||(i[0]=D("div",{class:"text-display-xl-mobile md:text-[56px] font-extrabold text-white mb-2 tracking-tighter"},"99.9%",-1)),D("div",gM,le(Se(e)("stats.reliability")),1)]),D("div",null,[i[1]||(i[1]=D("div",{class:"text-display-xl-mobile md:text-[56px] font-extrabold text-white mb-2 tracking-tighter"},"10x",-1)),D("div",_M,le(Se(e)("stats.speed")),1)]),D("div",null,[i[2]||(i[2]=D("div",{class:"text-display-xl-mobile md:text-[56px] font-extrabold text-white mb-2 tracking-tighter"},"100%",-1)),D("div",vM,le(Se(e)("stats.bespoke")),1)])])]))}},SM={id:"surec",class:"px-gutter py-section-padding-v-mobile md:py-section-padding-v"},yM={class:"max-w-container-max mx-auto"},MM={class:"text-center mb-20"},bM={class:"font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-4 text-white"},EM={class:"text-primary"},TM={class:"text-body-lg text-on-surface-variant max-w-2xl mx-auto opacity-70"},AM={class:"grid grid-cols-1 md:grid-cols-4 gap-4 relative"},wM={class:"w-10 h-10 bg-surface-obsidian text-primary border border-primary/20 rounded-md flex items-center justify-center mx-auto mb-6 font-bold text-sm group-hover:border-primary transition-colors"},RM={class:"font-headline-md text-[18px] mb-3 text-white"},CM={class:"text-on-surface-variant text-xs leading-relaxed opacity-80"},LM={__name:"ProcessSection",setup(n){const{t:e,messages:t,locale:i}=Dn(),r=["01","02","03","04"],s=Jt(()=>t[i.value].process.steps.map((a,o)=>({number:r[o],...a})));return(a,o)=>(be(),Te("section",SM,[D("div",yM,[D("div",MM,[D("h2",bM,[vt(le(Se(e)("process.title1"))+" ",1),D("span",EM,le(Se(e)("process.titleHighlight")),1)]),D("p",TM,le(Se(e)("process.subtitle")),1)]),D("div",AM,[o[0]||(o[0]=D("div",{class:"hidden md:block absolute top-1/2 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-white/5 to-transparent z-0"},null,-1)),(be(!0),Te(Qe,null,_t(s.value,(l,u)=>(be(),Te("div",{key:u,class:"relative z-10 glass-panel p-8 rounded-xl text-center group hover:bg-white/[0.03] transition-colors border-white/5"},[D("div",wM,le(l.number),1),D("h4",RM,le(l.title),1),D("p",CM,le(l.description),1)]))),128))])])]))}},PM={id:"iletisim",class:"px-gutter py-section-padding-v-mobile md:py-section-padding-v relative mesh-gradient"},DM={class:"max-w-4xl mx-auto glass-panel p-8 md:p-16 rounded-xl border-white/10 shadow-2xl"},UM={class:"text-center mb-12"},IM={class:"font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-4 text-white tracking-tight"},NM={class:"text-primary"},FM={class:"text-on-surface-variant"},OM={class:"mb-10 grid grid-cols-1 gap-3 border-y border-white/10 py-5 text-sm text-on-surface-variant md:grid-cols-3"},BM=["href"],zM={class:"flex items-center justify-center gap-2 md:justify-start"},kM=["href"],HM={class:"grid grid-cols-1 md:grid-cols-2 gap-6"},GM={class:"space-y-2"},VM={class:"text-label-sm uppercase tracking-widest text-on-surface-variant pl-1"},WM=["placeholder"],XM={class:"space-y-2"},$M={class:"text-label-sm uppercase tracking-widest text-on-surface-variant pl-1"},qM=["placeholder"],YM={class:"space-y-2"},jM={class:"text-label-sm uppercase tracking-widest text-on-surface-variant pl-1"},KM=["value"],ZM={class:"space-y-2"},JM={class:"text-label-sm uppercase tracking-widest text-on-surface-variant pl-1"},QM=["placeholder"],eb={class:"flex items-start gap-3 text-sm text-on-surface-variant"},tb=["disabled"],nb={__name:"ContactSection",setup(n){const{t:e,messages:t,locale:i}=Dn(),r=Jt(()=>t[i.value].contact.serviceOptions),s=Kr({name:"",email:"",service:"",details:"",consent:!1}),a=Hi(!1),o=Kr({message:"",success:!1});async function l(){o.message="",a.value=!0;try{const c=await(await fetch("https://sartechs-fullstack.vercel.app/api/contact",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({...s})})).json();o.message=c.message,o.success=c.success,c.success&&(s.name="",s.email="",s.service="",s.details="",s.consent=!1)}catch{o.message="Bağlantı hatası. Lütfen tekrar deneyin.",o.success=!1}finally{a.value=!1}}return(u,c)=>(be(),Te("section",PM,[D("div",DM,[D("div",UM,[D("h2",IM,[vt(le(Se(e)("contact.title1"))+" ",1),D("span",NM,le(Se(e)("contact.titleHighlight")),1),vt(" "+le(Se(e)("contact.title2")),1)]),D("p",FM,le(Se(e)("contact.subtitle")),1)]),D("div",OM,[D("a",{href:`mailto:${Se(e)("contact.email")}`,class:"flex items-center justify-center gap-2 transition-colors hover:text-white md:justify-start"},[c[5]||(c[5]=D("span",{class:"material-symbols-outlined text-primary"},"mail",-1)),vt(" "+le(Se(e)("contact.email")),1)],8,BM),D("span",zM,[c[6]||(c[6]=D("span",{class:"material-symbols-outlined text-primary"},"location_on",-1)),vt(" "+le(Se(e)("contact.location")),1)]),D("a",{href:`mailto:${Se(e)("contact.email")}?subject=${encodeURIComponent(Se(e)("contact.quickSubject"))}`,class:"flex items-center justify-center gap-2 font-semibold text-primary transition-colors hover:text-white md:justify-start"},[c[7]||(c[7]=D("span",{class:"material-symbols-outlined"},"bolt",-1)),vt(" "+le(Se(e)("contact.quickContact")),1)],8,kM)]),D("form",{class:"space-y-6",onSubmit:kr(l,["prevent"])},[D("div",HM,[D("div",GM,[D("label",VM,le(Se(e)("contact.labelName")),1),Cr(D("input",{"onUpdate:modelValue":c[0]||(c[0]=f=>s.name=f),type:"text",placeholder:Se(e)("contact.placeholderName"),class:"w-full bg-white/[0.03] border border-white/10 rounded-lg px-5 py-3.5 focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-white/10 text-white"},null,8,WM),[[Wo,s.name]])]),D("div",XM,[D("label",$M,le(Se(e)("contact.labelEmail")),1),Cr(D("input",{"onUpdate:modelValue":c[1]||(c[1]=f=>s.email=f),type:"email",placeholder:Se(e)("contact.placeholderEmail"),class:"w-full bg-white/[0.03] border border-white/10 rounded-lg px-5 py-3.5 focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-white/10 text-white"},null,8,qM),[[Wo,s.email]])])]),D("div",YM,[D("label",jM,le(Se(e)("contact.labelService")),1),Cr(D("select",{"onUpdate:modelValue":c[2]||(c[2]=f=>s.service=f),class:"w-full bg-white/[0.03] border border-white/10 rounded-lg px-5 py-3.5 focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all text-white appearance-none"},[(be(!0),Te(Qe,null,_t(r.value,f=>(be(),Te("option",{key:f,value:f,class:"bg-surface-obsidian"},le(f),9,KM))),128))],512),[[Jp,s.service]])]),D("div",ZM,[D("label",JM,le(Se(e)("contact.labelDetails")),1),Cr(D("textarea",{"onUpdate:modelValue":c[3]||(c[3]=f=>s.details=f),rows:"4",placeholder:Se(e)("contact.placeholderDetails"),class:"w-full bg-white/[0.03] border border-white/10 rounded-lg px-5 py-3.5 focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all placeholder:text-white/10 text-white"},null,8,QM),[[Wo,s.details]])]),D("label",eb,[Cr(D("input",{"onUpdate:modelValue":c[4]||(c[4]=f=>s.consent=f),type:"checkbox",required:"",class:"mt-1 h-4 w-4 accent-primary"},null,512),[[Zp,s.consent]]),D("span",null,le(Se(e)("contact.consent")),1)]),D("button",{type:"submit",disabled:a.value,class:"w-full py-4 bg-primary text-white rounded-lg font-bold text-base glow-button tracking-widest transition-all uppercase disabled:opacity-50 disabled:cursor-not-allowed"},le(a.value?"...":Se(e)("contact.submit")),9,tb),o.message?(be(),Te("p",{key:0,class:Kt([o.success?"text-green-400":"text-red-400","text-center text-sm pt-2"])},le(o.message),3)):yo("",!0)],32)])]))}},ib={id:"hakkimizda",class:"px-gutter py-section-padding-v-mobile md:py-section-padding-v bg-surface-container-lowest/30"},rb={class:"max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center"},sb={class:"inline-flex items-center rounded-full border border-primary/20 bg-primary/10 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.28em] text-primary mb-6"},ob={class:"font-headline-lg-mobile md:font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-6 text-white tracking-tight"},ab={class:"text-primary"},lb={class:"text-body-lg text-on-surface-variant max-w-xl leading-relaxed mb-8"},cb={class:"space-y-4"},ub={class:"leading-relaxed"},fb={class:"relative"},db={class:"glass-panel relative overflow-hidden rounded-2xl border border-white/10 p-6 md:p-8 shadow-[0_30px_60px_-20px_rgba(14,165,233,0.20)]"},hb={class:"mb-6 flex items-center justify-between"},pb={class:"text-[10px] font-bold uppercase tracking-[0.28em] text-on-surface-variant"},mb={class:"mt-2 text-xl font-semibold text-white"},gb={class:"space-y-4"},_b={class:"mb-2 flex items-center justify-between"},vb={class:"text-sm font-medium text-white"},xb={class:"text-primary text-xs font-semibold uppercase tracking-[0.18em]"},Sb={key:0,class:"text-sm leading-relaxed text-on-surface-variant"},yb={key:1,class:"mt-3 flex flex-wrap gap-2"},Mb={__name:"AboutSection",setup(n){const{t:e,messages:t,locale:i}=Dn(),r=Jt(()=>t[i.value].about.points),s=Jt(()=>t[i.value].about.techs),a=Jt(()=>t[i.value].about.card.items);return(o,l)=>(be(),Te("section",ib,[D("div",rb,[D("div",null,[D("span",sb,le(Se(e)("nav.about")),1),D("h2",ob,[vt(le(Se(e)("about.title1"))+" ",1),D("span",ab,le(Se(e)("about.titleHighlight")),1),vt(" "+le(Se(e)("about.title2")),1)]),D("p",lb,le(Se(e)("about.subtitle")),1),D("ul",cb,[(be(!0),Te(Qe,null,_t(r.value,(u,c)=>(be(),Te("li",{key:c,class:"flex items-start gap-3 text-on-surface-variant"},[l[0]||(l[0]=D("span",{class:"mt-1 flex h-6 w-6 items-center justify-center rounded-full bg-primary/10 text-primary border border-primary/20"},[D("span",{class:"material-symbols-outlined text-[14px]"},"check")],-1)),D("span",ub,le(u),1)]))),128))])]),D("div",fb,[l[2]||(l[2]=D("div",{class:"absolute -right-8 top-8 h-32 w-32 rounded-full bg-primary/10 blur-3xl"},null,-1)),D("div",db,[l[1]||(l[1]=D("div",{class:"absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/80 to-transparent"},null,-1)),D("div",hb,[D("div",null,[D("p",pb,le(Se(e)("about.card.label")),1),D("h3",mb,le(Se(e)("about.card.title")),1)])]),D("div",gb,[(be(!0),Te(Qe,null,_t(a.value,(u,c)=>(be(),Te("div",{key:c,class:"rounded-xl border border-white/10 bg-white/[0.02] p-4"},[D("div",_b,[D("span",vb,le(u.title),1),D("span",xb,le(String(c+1).padStart(2,"0")),1)]),u.description?(be(),Te("p",Sb,le(u.description),1)):c===a.value.length-1?(be(),Te("div",yb,[(be(!0),Te(Qe,null,_t(s.value,(f,d)=>(be(),Te("span",{key:d,class:"rounded-full border border-white/10 bg-white/[0.03] px-2.5 py-1.5 text-[11px] text-white/80"},le(f),1))),128))])):yo("",!0)]))),128))])])])])]))}},bb={class:"w-full border-t border-white/5 bg-surface-obsidian"},Eb={class:"flex flex-col md:flex-row justify-between items-center px-gutter py-section-padding-v-mobile max-w-container-max mx-auto gap-8"},Tb={class:"flex flex-col items-center md:items-start gap-4"},Ab={class:"text-on-surface-variant text-xs max-w-xs text-center md:text-left opacity-60"},wb={class:"flex gap-12"},Rb={class:"flex flex-col gap-3 text-center md:text-left"},Cb={class:"font-label-md text-primary mb-2 uppercase tracking-widest text-[10px]"},Lb=["href"],Pb={class:"flex flex-col gap-3 text-center md:text-left"},Db={class:"font-label-md text-primary mb-2 uppercase tracking-widest text-[10px]"},Ub=["href"],Ib={class:"flex flex-col items-center md:items-end gap-6"},Nb={class:"font-body-md text-[11px] text-on-surface-variant opacity-40"},Fb={class:"max-w-container-max mx-auto grid gap-4 border-t border-white/5 px-gutter py-8 text-xs leading-relaxed text-on-surface-variant md:grid-cols-3"},Ob=["id"],Bb={class:"cursor-pointer list-none font-semibold text-white transition-colors group-open:text-primary"},zb={class:"mt-3 max-w-xl"},kb={__name:"AppFooter",setup(n){const{t:e}=Dn();return(t,i)=>(be(),Te("footer",bb,[D("div",Eb,[D("div",Tb,[i[0]||(i[0]=D("img",{src:"https://lh3.googleusercontent.com/aida/AP1WRLty_fiSjelvnvJUU_N9Vgoqa25s-UYGEfXUw3XsRfqQeEVJsggnyXPwHaO2vaOsO7PgQOOcEMNlh-KiVFSFU-YO4Y3ShyMAICfmpEo18XkrYAVDE_qPXCHTd0Cy-P5dg5pg_O50VYFEJgYJwz1fnZlmQR5gLLDeW1DbsSo0eENeHzU_dEZ0d3UtPAt4ZVJ4eD6MoO9x9tFEM_4JutbsQbTs3wyc9ZlLVTvnLKWOBNAckoIa0p2RmgirmWs",alt:"Sartechs",class:"h-10 w-auto logo-filter"},null,-1)),D("p",Ab,le(Se(e)("footer.tagline")),1)]),D("div",wb,[D("div",Rb,[D("span",Cb,le(Se(e)("footer.company")),1),(be(!0),Te(Qe,null,_t(Se(e)("footer.companyLinks"),r=>(be(),Te("a",{key:r.label,href:r.href,class:"text-on-surface-variant hover:text-white transition-colors text-xs"},le(r.label),9,Lb))),128))]),D("div",Pb,[D("span",Db,le(Se(e)("footer.support")),1),(be(!0),Te(Qe,null,_t(Se(e)("footer.supportLinks"),r=>(be(),Te("a",{key:r.label,href:r.href,class:"text-on-surface-variant hover:text-white transition-colors text-xs"},le(r.label),9,Ub))),128))])]),D("div",Ib,[i[1]||(i[1]=fp('<div class="flex gap-4"><a href="mailto:sariibasmuhammed@gmail.com" aria-label="E-posta gönder" class="w-9 h-9 glass-panel rounded-lg flex items-center justify-center hover:bg-primary/10 transition-all border-white/5"><span class="material-symbols-outlined text-[18px]">share</span></a><a href="mailto:sariibasmuhammed@gmail.com" aria-label="E-posta gönder" class="w-9 h-9 glass-panel rounded-lg flex items-center justify-center hover:bg-primary/10 transition-all border-white/5"><span class="material-symbols-outlined text-[18px]">alternate_email</span></a></div>',1)),D("p",Nb,"© "+le(new Date().getFullYear())+" "+le(Se(e)("footer.copyright")),1)])]),D("div",Fb,[(be(!0),Te(Qe,null,_t(Se(e)("footer.legalDocuments"),r=>(be(),Te("details",{id:r.id,key:r.id,class:"group"},[D("summary",Bb,le(r.title),1),D("p",zb,le(r.body),1)],8,Ob))),128))])]))}},Hb={class:"font-body-md text-on-surface selection:bg-primary/30 selection:text-white"},Gb={class:"relative pt-24 overflow-hidden"},Vb={__name:"App",setup(n){return om(),(e,t)=>(be(),Te("div",Hb,[rt(_m),D("main",Gb,[rt(cy),rt(Zy),rt(hM),rt(xM),rt(LM),rt(Mb),rt(Oy),rt(nb)]),rt(kb)]))}};im(Vb).mount("#app");
